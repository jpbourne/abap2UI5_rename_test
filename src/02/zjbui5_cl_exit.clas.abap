CLASS zjbui5_cl_exit DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    INTERFACES zjbui5_if_exit.

    CLASS-METHODS init_context
      IMPORTING
        http_info TYPE zjbui5_cl_util_http=>ty_s_http_req.

    CLASS-METHODS get_instance
      RETURNING
        VALUE(ri_exit) TYPE REF TO zjbui5_if_exit.
  ...
  PROTECTED SECTION.
    CLASS-DATA gi_me        TYPE REF TO zjbui5_if_exit.
    CLASS-DATA gi_user_exit TYPE REF TO zjbui5_if_exit.
    CLASS-DATA context TYPE zjbui5_if_types=>ty_s_http_context.

ENDCLASS.



CLASS zjbui5_cl_exit IMPLEMENTATION.
  ...
  METHOD get_user_exit_class.
    ...
    DATA(exit_classes) = zjbui5_cl_util_abap=>rtti_get_classes_impl_intf( 'Z2UI5_IF_EXIT' ).
  ...
  METHOD zjbui5_if_exit~set_config_http_get.
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
  ...
  METHOD zjbui5_if_exit~set_config_http_post.
