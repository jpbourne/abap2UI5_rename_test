CLASS zjbui5_cl_http_handler DEFINITION
  PUBLIC
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_http_handler.
    ...
    METHODS main
      IMPORTING
        s_config TYPE zjbui5_if_types=>ty_s_http_config OPTIONAL.
    ...
    CLASS-METHODS get_request
      IMPORTING
        ...
        res           TYPE REF TO object OPTIONAL
          PREFERRED PARAMETER server
      RETURNING
        VALUE(result) TYPE zjbui5_if_core_types=>ty_s_http_req.
  ...
  PROTECTED SECTION.
    ...
    DATA mo_server TYPE REF TO zjbui5_cl_util_abap_http.
...
CLASS zjbui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = zjbui5_cl_util_abap_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = zjbui5_cl_util_abap_http=>factory_cloud( req = req
                                                               res  = res ).
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
  ...
  METHOD _http_post.
    ...
    TRY.
        IF lo_post IS BOUND.
          DATA(li_app) = CAST zjbui5_if_app( lo_post->mo_action->mo_app->mo_app ).
