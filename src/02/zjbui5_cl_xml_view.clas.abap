CLASS zjbui5_cl_xml_view DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    CLASS-METHODS factory
      IMPORTING
        t_ns          TYPE zjbui5_if_types=>ty_t_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_xml_view.
    ...
    METHODS avatar_group
      IMPORTING !id                     TYPE clike     OPTIONAL
                ...
                items                   TYPE clike     OPTIONAL
                press                   TYPE clike     OPTIONAL
      RETURNING VALUE(result)           TYPE REF TO zjbui5_cl_xml_view.
    ...
    METHODS _generic
      IMPORTING
        name          TYPE clike
        ns            TYPE clike                           OPTIONAL
        t_prop        TYPE zjbui5_if_types=>ty_t_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_xml_view.

    METHODS _generic_property
      IMPORTING
        val           TYPE zjbui5_if_types=>ty_s_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_xml_view.
    ...
    METHODS _z2ui5
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_xml_view_cc.
  ...
  PROTECTED SECTION.
    ...
    DATA mt_prop     TYPE SORTED TABLE OF zjbui5_if_types=>ty_s_name_value WITH NON-UNIQUE KEY n.

    DATA mt_ns       TYPE SORTED TABLE OF string WITH UNIQUE KEY table_line.
    DATA mo_root     TYPE REF TO zjbui5_cl_xml_view.
    DATA mo_previous TYPE REF TO zjbui5_cl_xml_view.
    DATA mo_parent   TYPE REF TO zjbui5_cl_xml_view.
    DATA mt_child    TYPE STANDARD TABLE OF REF TO zjbui5_cl_xml_view WITH EMPTY KEY.

  PRIVATE SECTION.
ENDCLASS.


CLASS zjbui5_cl_xml_view IMPLEMENTATION.
  ...
  METHOD action_button.
    result = _generic( name   = `ActionButton`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `title`    v = title )
                                         ( n = `press`    v = press )
                                         ( n = `enabled`  v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) ) ) ).
  ENDMETHOD.
  ...
  METHOD action_sheet.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`  v = id )
                                   ...
                                   ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD area_micro_chart.
    ...
    _generic( name   = `AreaMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `showLabel`    v = zjbui5_cl_util=>boolean_abap_2_json( showlabel ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD avatar.
    ...
    _generic( name   = `Avatar`
              ...
              t_prop = VALUE #( ( n = `id` v = id )
                                ...
                                ( n = `showBorder`       v = zjbui5_cl_util=>boolean_abap_2_json( showborder ) )
                                ( n = `decorative`       v = zjbui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `enabled`       v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
  ...
  METHOD avatar_group.
    result = _generic( name   = `AvatarGroup`
                       ...
                       t_prop = VALUE #( ( n = `id` v = id )
                                         ...
                                         ( n = `blocked` v = zjbui5_cl_util=>boolean_abap_2_json( blocked ) )
                                         ( n = `busy` v = zjbui5_cl_util=>boolean_abap_2_json( busy ) )
  ...
  METHOD base_rectangle.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `time`                      v = time )
                          ( n = `endTime`                   v = endtime )
                          ( n = `selectable`                v = zjbui5_cl_util=>boolean_abap_2_json( selectable ) )
                          ...
                          ( n = `connectable`               v = zjbui5_cl_util=>boolean_abap_2_json( connectable ) )
                          ( n = `fontFamily`                v = fontfamily )
                          ( n = `filter`                    v = filter )
                          ( n = `transform`                 v = transform )
                          ( n = `countInBirdEye`            v = zjbui5_cl_util=>boolean_abap_2_json( countinbirdeye ) )
                          ( n = `fontWeight`                v = fontweight )
                          ( n = `showTitle`                 v = zjbui5_cl_util=>boolean_abap_2_json( showtitle ) )
                          ( n = `selected`                  v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                          ( n = `resizable`                 v = zjbui5_cl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `horizontalTextAlignment`   v = horizontaltextalignment )
                          ( n = `shapeId`                   v = shapeid )
                          ( n = `highlighted`               v = zjbui5_cl_util=>boolean_abap_2_json( highlighted ) )
                          ( n = `highlightable`             v = zjbui5_cl_util=>boolean_abap_2_json( highlightable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD bullet_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `actualValueLabel`  v = actualvaluelabel )
                          ...
                          ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `showActualValue`    v = zjbui5_cl_util=>boolean_abap_2_json( showactualvalue ) )
                          ( n = `showActualValueInDeltaMode`    v = zjbui5_cl_util=>boolean_abap_2_json( savidm ) )
                          ( n = `showDeltaValue`    v = zjbui5_cl_util=>boolean_abap_2_json( showdeltavalue ) )
                          ( n = `showTargetValue`    v = zjbui5_cl_util=>boolean_abap_2_json( showtargetvalue ) )
                          ( n = `showThresholds`    v = zjbui5_cl_util=>boolean_abap_2_json( showthresholds ) )
                          ( n = `showValueMarker`    v = zjbui5_cl_util=>boolean_abap_2_json( showvaluemarker ) )
                          ( n = `smallRangeAllowed`    v = zjbui5_cl_util=>boolean_abap_2_json( smallrangeallowed ) )
  ...
  METHOD busy_indicator.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `customIconDensityAware`           v = zjbui5_cl_util=>boolean_abap_2_json( customicondensityaware ) )
            ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD button.
    ...
    _generic( name   = `Button`
              ...
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `enabled` v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `iconDensityAware` v = zjbui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst` v = zjbui5_cl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `icon`    v = icon )
                                ( n = `type`    v = type )
                                ( n = `id`      v = id )
                                ( n = `width`   v = width )
  ...
  METHOD calendar_appointment.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `startDate`                 v = startdate )
                          ...
                          ( n = `key`                       v = key )
                          ( n = `selected`                 v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                          ( n = `tentative`                 v = zjbui5_cl_util=>boolean_abap_2_json( tentative ) )
                        ) ).
  ENDMETHOD.
  ...
  METHOD card_header.
    result = _generic( name   = `Header`
                       ...
                       t_prop = VALUE #( ( n = `id`  v = id )
                                         ...
                                         ( n = `iconVisible`  v = zjbui5_cl_util=>boolean_abap_2_json( iconvisible ) )
                                         ( n = `visible`    v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD carousel.
    ...
    result = _generic( name   = `Carousel`
                       t_prop = VALUE #( ( n = `loop`  v = zjbui5_cl_util=>boolean_abap_2_json( loop ) )
                                         ( n = `class`  v = class )
                                         ( n = `height`  v = height )
                                         ( n = `id`  v = id )
  ...
  METHOD checkbox.
    ...
    _generic( name   = `CheckBox`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ...
                                ( n = `width` v = width )
                                ( n = `activeHandling`  v = zjbui5_cl_util=>boolean_abap_2_json( activehandling ) )
                                ( n = `enabled`  v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `displayOnly`  v = zjbui5_cl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `editable`  v = zjbui5_cl_util=>boolean_abap_2_json( editable ) )
                                ( n = `partiallySelected`  v = zjbui5_cl_util=>boolean_abap_2_json( partiallyselected ) )
                                ( n = `useEntireWidth`  v = zjbui5_cl_util=>boolean_abap_2_json( useentirewidth ) )
                                ( n = `wrapping`  v = zjbui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `select`   v = select )
                                ( n = `required`   v = zjbui5_cl_util=>boolean_abap_2_json( required ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `width` v = width )
                                   ...
                                   ( n = `id`         v = id )
                                   ( n = `class`         v = class )
                                   ( n = `mergeDuplicates` v = zjbui5_cl_util=>boolean_abap_2_json( mergeduplicates ) )
                                   ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `demandPopin` v = zjbui5_cl_util=>boolean_abap_2_json( demandpopin ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_list_item.
    result = _generic( name   = `ColumnListItem`
                       t_prop = VALUE #( ( n = `vAlign`   v = valign )
                                         ( n = `id` v = id )
                                         ( n = `selected` v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `unread` v = zjbui5_cl_util=>boolean_abap_2_json( unread ) )
                                         ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `type`     v = type )
                                         ( n = `counter`     v = counter )
                                         ...
                                         ( n = `navigated`     v = zjbui5_cl_util=>boolean_abap_2_json( navigated ) )
                                         ( n = `press`    v = press ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_item.
    result = _generic( name   = `Item`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `confirm`    v = confirm )
                           ( n = `reset`    v = reset )
                           ( n = `resetButtonEnabled`  v = zjbui5_cl_util=>boolean_abap_2_json( resetbuttonenabled ) )
                           ( n = `showCancelButton`  v = zjbui5_cl_util=>boolean_abap_2_json( showcancelbutton ) )
                           ( n = `showConfirmButton`  v = zjbui5_cl_util=>boolean_abap_2_json( showconfirmbutton ) )
                           ( n = `showResetButton`  v = zjbui5_cl_util=>boolean_abap_2_json( showresetbutton ) )
                           ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_group_item.
    result = _generic( name   = `QuickGroupItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `label`    v = label )
                                         ( n = `grouped`  v = zjbui5_cl_util=>boolean_abap_2_json( grouped ) )
                                         ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_total_item.
    result = _generic( name   = `QuickTotalItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `label`    v = label )
                                         ( n = `totaled`  v = zjbui5_cl_util=>boolean_abap_2_json( totaled ) )
                                         ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `width`  v = width )
                          ...
                          ( n = `alignContent`      v = aligncontent )
                          ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `allowColumnLabels`    v = zjbui5_cl_util=>boolean_abap_2_json( allowcolumnlabels ) )
                          ( n = `showBottomLabels`    v = zjbui5_cl_util=>boolean_abap_2_json( showbottomlabels ) )
                          ( n = `showTopLabels`    v = zjbui5_cl_util=>boolean_abap_2_json( showtoplabels ) )
                          ( n = `height`  v = height ) ) ).
  ENDMETHOD.
  ...
  METHOD combobox.
    result = _generic(
        name   = `ComboBox`
        t_prop = VALUE #(
            (  n = `showClearIcon` v = zjbui5_cl_util=>boolean_abap_2_json( showclearicon ) )
            ...
            (  n = `textAlign`         v = textalign )
            (  n = `showSecondaryValues`         v = zjbui5_cl_util=>boolean_abap_2_json( showsecondaryvalues ) )
            (  n = `visible`         v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
            (  n = `showValueStateMessage`         v = zjbui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
            (  n = `showButton`         v = zjbui5_cl_util=>boolean_abap_2_json( showbutton ) )
            (  n = `required`         v = zjbui5_cl_util=>boolean_abap_2_json( required ) )
            (  n = `editable`         v = zjbui5_cl_util=>boolean_abap_2_json( editable ) )
            (  n = `enabled`         v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
            (  n = `filterSecondaryValues`         v = zjbui5_cl_util=>boolean_abap_2_json( filtersecondaryvalues ) )
            (  n = `width`         v = width )
  ...
  METHOD comparison_micro_chart.
    result = _generic( name  = `ComparisonMicroChart`
                      ...
                      t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                        ...
                                        ( n = `width`      v = width )
                                        ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                        ( n = `shrinkable`    v = zjbui5_cl_util=>boolean_abap_2_json( shrinkable ) )
                                        ( n = `visible`    v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                        ( n = `view`  v = view ) ) ).
  ENDMETHOD.
  ...
  METHOD container_toolbar.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `alignCustomContentToRight` v = zjbui5_cl_util=>boolean_abap_2_json( aligncustomcontenttoright ) )
            ( n = `findMode`                  v = findmode )
            ( n = `infoOfSelectItems`         v = infoofselectitems )
            ( n = `findbuttonpress`           v = findbuttonpress )
            ( n = `showBirdEyeButton`         v = zjbui5_cl_util=>boolean_abap_2_json( showbirdeyebutton ) )
            ( n = `showDisplayTypeButton`     v = zjbui5_cl_util=>boolean_abap_2_json( showdisplaytypebutton ) )
            ( n = `showLegendButton`          v = zjbui5_cl_util=>boolean_abap_2_json( showlegendbutton ) )
            ( n = `showSettingButton`         v = zjbui5_cl_util=>boolean_abap_2_json( showsettingbutton ) )
            ( n = `showTimeZoomControl`       v = zjbui5_cl_util=>boolean_abap_2_json( showtimezoomcontrol ) )
  ...
  METHOD core_custom_data.
    ...
    _generic( name   = `CustomData`
              ...
              t_prop = VALUE #( ( n = `value` v = value )
                                ( n = `key` v = key )
                                ( n = `writeToDom` v = zjbui5_cl_util=>boolean_abap_2_json( writetodom ) ) ) ).
  ...
  METHOD currency.
    result = _generic( name   = `Currency`
                       ...
                       t_prop = VALUE #( ( n = `value`        v = value )
                                         ...
                                         ( n = `useSymbol`    v = zjbui5_cl_util=>boolean_abap_2_json( usesymbol ) )
  ...
  METHOD date_picker.
    ...
    _generic( name   = `DatePicker`
              t_prop = VALUE #(
                  ...
                  ( n = `visible`               v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                  ( n = `editable`              v = zjbui5_cl_util=>boolean_abap_2_json( editable ) )
                  ( n = `hideInput`             v = zjbui5_cl_util=>boolean_abap_2_json( hideinput ) )
                  ( n = `showFooter`            v = zjbui5_cl_util=>boolean_abap_2_json( showfooter ) )
                  ( n = `showValueStateMessage` v = zjbui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                  ( n = `showCurrentDateButton` v = zjbui5_cl_util=>boolean_abap_2_json( showcurrentdatebutton ) ) ) ).
  ENDMETHOD.
  ...
  METHOD dialog.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `title`  v = title )
                          ...
                          ( n = `closeOnNavigation`  v = zjbui5_cl_util=>boolean_abap_2_json( closeonnavigation ) )
                          ( n = `draggable`  v = zjbui5_cl_util=>boolean_abap_2_json( draggable ) )
                          ( n = `resizable`  v = zjbui5_cl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `horizontalScrolling`  v = zjbui5_cl_util=>boolean_abap_2_json( horizontalscrolling ) )
                          ( n = `verticalScrolling`  v = zjbui5_cl_util=>boolean_abap_2_json( verticalscrolling ) )
                          ( n = `afterOpen`  v = afteropen )
                          ( n = `beforeClose`  v = beforeclose )
                          ( n = `beforeOpen`  v = beforeopen )
                          ( n = `afterClose` v = afterclose ) ) ).
  ...
  METHOD dynamic_page.
    result = _generic( name   = `DynamicPage`
                       ns     = `f`
                       t_prop = VALUE #(
                           (  n = `headerExpanded`           v = zjbui5_cl_util=>boolean_abap_2_json( headerexpanded ) )
                           (  n = `headerPinned`           v = zjbui5_cl_util=>boolean_abap_2_json( headerpinned ) )
                           (  n = `showFooter`           v = zjbui5_cl_util=>boolean_abap_2_json( showfooter ) )
  ...
  METHOD dynamic_page_header.
    result = _generic(
                 ...
                 ns     = `f`
                 t_prop = VALUE #( (  n = `pinnable`           v = zjbui5_cl_util=>boolean_abap_2_json( pinnable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD expandable_text.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `renderWhitespace`             v = zjbui5_cl_util=>boolean_abap_2_json( renderwhitespace ) )
                     ( n = `text`        v = text )
                     ( n = `textAlign`         v = textalign )
                     ( n = `textDirection`       v = textdirection )
  ...
  METHOD facet_filter.
    result = _generic( name   = `FacetFilter`
                       t_prop = VALUE #(
                           ( n = `id`  v = id )
                           ( n = `class`  v = class )
                           ( n = `liveSearch`  v = zjbui5_cl_util=>boolean_abap_2_json( livesearch ) )
                           ( n = `showPersonalization` v = zjbui5_cl_util=>boolean_abap_2_json( showpersonalization ) )
                           ( n = `showPopoverOKButton`  v = zjbui5_cl_util=>boolean_abap_2_json( showpopoverokbutton ) )
                           ( n = `showReset`             v = zjbui5_cl_util=>boolean_abap_2_json( showreset ) )
                           ( n = `showSummaryBar`        v = zjbui5_cl_util=>boolean_abap_2_json( showsummarybar ) )
                           ( n = `type`         v = type )
                           ( n = `confirm`        v = confirm )
                           ( n = `reset` v = reset )
                           ( n = `lists` v = lists )
  ...
  METHOD facet_filter_list.
    result = _generic(
        ...
        t_prop = VALUE #(
            ( n = `id`  v = id )
            ( n = `class`  v = class )
            ( n = `active`  v = zjbui5_cl_util=>boolean_abap_2_json( active ) )
            ( n = `allCount`  v = allcount )
            ( n = `backgroundDesign`         v = backgrounddesign )
            ( n = `dataType`  v = datatype )
            ( n = `enableBusyIndicator` v = zjbui5_cl_util=>boolean_abap_2_json( enablebusyindicator ) )
            ( n = `enableCaseInsensitiveSearch` v = zjbui5_cl_util=>boolean_abap_2_json( enablecaseinsensitivesearch ) )
            ( n = `footerText`         v = footertext )
            ( n = `growing`       v = zjbui5_cl_util=>boolean_abap_2_json( growing ) )
            ( n = `growingDirection`        v = growingdirection )
            ( n = `growingScrollToLoad` v = zjbui5_cl_util=>boolean_abap_2_json( growingscrolltoload ) )
            ( n = `growingThreshold` v = growingthreshold )
            ( n = `growingTriggerText` v = growingtriggertext )
            ( n = `headerLevel` v = headerlevel )
            ( n = `includeItemInSelection` v = zjbui5_cl_util=>boolean_abap_2_json( includeiteminselection ) )
            ( n = `inset` v = zjbui5_cl_util=>boolean_abap_2_json( inset ) )
            ( n = `key` v = key )
            ( n = `swipedirection` v = swipedirection )
            ( n = `headerText` v = headertext )
            ( n = `keyboardMode` v = keyboardmode )
            ( n = `mode` v = mode )
            ( n = `modeAnimationOn` v = zjbui5_cl_util=>boolean_abap_2_json( modeanimationon ) )
            ( n = `multiSelectMode` v = multiselectmode )
            ( n = `noDataText` v = nodatatext )
            ( n = `rememberSelections` v = zjbui5_cl_util=>boolean_abap_2_json( rememberselections ) )
            ( n = `retainListSequence` v = zjbui5_cl_util=>boolean_abap_2_json( retainlistsequence ) )
            ( n = `sequence` v = sequence )
            ( n = `showNoData` v = zjbui5_cl_util=>boolean_abap_2_json( shownodata ) )
            ( n = `showRemoveFacetIcon` v = zjbui5_cl_util=>boolean_abap_2_json( showremovefaceticon ) )
            ( n = `showSeparators` v = showseparators )
            ( n = `showUnread` v = zjbui5_cl_util=>boolean_abap_2_json( showunread ) )
            ( n = `sticky` v = sticky )
            ( n = `title` v = title )
            ( n = `width` v = width )
            ( n = `wordWrap` v = zjbui5_cl_util=>boolean_abap_2_json( wordwrap ) )
  ...
  METHOD feed_input.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `buttonTooltip`    v = buttontooltip )
                                   ...
                                   ( n = `placeholder`      v = placeholder )
                                   ( n = `rows`             v = rows )
                                   ( n = `showExceededText` v = zjbui5_cl_util=>boolean_abap_2_json( showexceededtext ) )
                                   ( n = `showIcon`         v = zjbui5_cl_util=>boolean_abap_2_json( showicon ) )
                                   ( n = `value`            v = value )
                                   ( n = `class`            v = class )
                                   ( n = `post`             v = post ) ) ).
  ...
  METHOD feed_list_item.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `iconActive`                  v = zjbui5_cl_util=>boolean_abap_2_json( iconactive ) )
                     ( n = `icon`                        v = icon )
                     ( n = `iconDensityAware`            v = zjbui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                     ( n = `iconDisplayShape`            v = icondisplayshape )
                     ( n = `iconInitials`                v = iconinitials )
                     ...
                     ( n = `sender`                      v = sender )
                     ( n = `senderActive`                v = zjbui5_cl_util=>boolean_abap_2_json( senderactive ) )
                     ( n = `showIcon`                    v = zjbui5_cl_util=>boolean_abap_2_json( showicon ) )
                     ( n = `text`                        v = text )
  ...
  METHOD feed_list_item_action.
    result = _generic( name   = `FeedListItemAction`
                       t_prop = VALUE #( ( n = `enabled` v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `icon`    v = icon )
                                         ( n = `key`     v = key )
                                         ( n = `text`    v = text )
                                         ( n = `press`   v = press )
  ...
  METHOD filter_bar.
    ...
    result = _generic(
        ...
        ns     = 'fb'
        t_prop = VALUE #(
            ( n = 'useToolbar'     v = zjbui5_cl_util=>boolean_abap_2_json( usetoolbar ) )
            ( n = 'search'         v = search )
            ( n = 'id'             v = id )
            ...
            ( n = 'header' v = header )
            ( n = 'advancedMode' v = zjbui5_cl_util=>boolean_abap_2_json( advancedmode ) )
            ( n = 'isRunningInValueHelpDialog' v = zjbui5_cl_util=>boolean_abap_2_json( isrunninginvaluehelpdialog ) )
            ( n = 'showAllFilters' v = zjbui5_cl_util=>boolean_abap_2_json( showallfilters ) )
            ( n = 'showClearOnFB' v = zjbui5_cl_util=>boolean_abap_2_json( showclearonfb ) )
            ( n = 'showFilterConfiguration' v = zjbui5_cl_util=>boolean_abap_2_json( showfilterconfiguration ) )
            ( n = 'showGoOnFB' v = zjbui5_cl_util=>boolean_abap_2_json( showgoonfb ) )
            ( n = 'showRestoreButton' v = zjbui5_cl_util=>boolean_abap_2_json( showrestorebutton ) )
            ( n = 'showRestoreOnFB' v = zjbui5_cl_util=>boolean_abap_2_json( showrestoreonfb ) )
            ( n = 'useSnapshot' v = zjbui5_cl_util=>boolean_abap_2_json( usesnapshot ) )
            ( n = 'searchEnabled' v = zjbui5_cl_util=>boolean_abap_2_json( searchenabled ) )
            ( n = 'considerGroupTitle' v = zjbui5_cl_util=>boolean_abap_2_json( considergrouptitle ) )
            ( n = 'deltaVariantMode' v = zjbui5_cl_util=>boolean_abap_2_json( deltavariantmode ) )
            ( n = 'disableSearchMatchesPatternWarning'
              v = zjbui5_cl_util=>boolean_abap_2_json( disablesearchmatchespatternw ) )
            ( n = 'filterBarExpanded' v = zjbui5_cl_util=>boolean_abap_2_json( filterbarexpanded ) )
  ...
  METHOD filter_group_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = 'name'                v  = name )
                          ...
                          ( n = 'change'           v  = change )
                          ( n = 'visibleInFilterBar'  v  = zjbui5_cl_util=>boolean_abap_2_json( visibleinfilterbar ) )
                          ( n = 'mandatory'  v  = zjbui5_cl_util=>boolean_abap_2_json( mandatory ) )
                          ( n = 'hiddenFilter'  v  = zjbui5_cl_util=>boolean_abap_2_json( hiddenfilter ) )
                          ( n = 'visible'  v  = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                        ) ).
  ...
  METHOD flexible_column_layout.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            (  n = `autoFocus` v = zjbui5_cl_util=>boolean_abap_2_json( autofocus ) )
            (  n = `restoreFocusOnBackNavigation` v = zjbui5_cl_util=>boolean_abap_2_json( restorefocusonbacknavigation ) ) ) ).
  ...
  METHOD flex_box.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `class`  v = class )
                                   ...
                                   ( n = `fitContainer`  v = zjbui5_cl_util=>boolean_abap_2_json( fitcontainer ) )
                                   ...
                                   ( n = `alignContent`  v = aligncontent )
                                   ( n = `backgroundDesign`  v = backgrounddesign )
                                   ( n = `displayInline`  v = zjbui5_cl_util=>boolean_abap_2_json( displayinline ) )
                                   ( n = `visible`        v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD gantt_chart_with_table.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `isConnectorDetailsVisible` v = zjbui5_cl_util=>boolean_abap_2_json( isconnectordetailsvisible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD generic_tile.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                     ( n = `renderOnThemeChange`  v = zjbui5_cl_util=>boolean_abap_2_json( renderonthemechange ) )
                     ( n = `enableNavigationButton`  v = zjbui5_cl_util=>boolean_abap_2_json( enablenavigationbutton ) )
                     ( n = `pressEnabled`  v = zjbui5_cl_util=>boolean_abap_2_json( pressenabled ) )
                     ( n = `iconLoaded`  v = zjbui5_cl_util=>boolean_abap_2_json( iconloaded ) )
  ...
  METHOD grid.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `defaultSpan`    v = default_span )
                                   ( n = `class`          v = class )
                                   ( n = `containerQuery` v = zjbui5_cl_util=>boolean_abap_2_json( containerquery ) )
  ...
  METHOD grid_data.
    ...
    _generic( name   = `GridData`
              ...
              t_prop = VALUE #( ( n = `span`      v = span )
                                ( n = `linebreak` v = zjbui5_cl_util=>boolean_abap_2_json( linebreak ) )
                                ( n = `indentL`   v = indentl )
                                ( n = `indentM`   v = indentm ) ) ).
  ENDMETHOD.
  ...
  METHOD group.
    result = _generic( name   = `group`
                       ns     = `networkgraph`
                       t_prop = VALUE #( ( n = `collapsed`  v = zjbui5_cl_util=>boolean_abap_2_json( collapsed ) )
                                         ( n = `id`       v = id )
                                         ( n = `class`       v = class )
  ...
  METHOD harvey_ball_micro_chart.
    ...
    result = _generic( name = `HarveyBallMicroChart`
              ...
              t_prop        = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `alignContent`      v = aligncontent )
                                ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `formattedLabel`    v = zjbui5_cl_util=>boolean_abap_2_json( formattedlabel ) )
                                ( n = `showFractions`    v = zjbui5_cl_util=>boolean_abap_2_json( showfractions ) )
                                ( n = `showTotal`    v = zjbui5_cl_util=>boolean_abap_2_json( showtotal ) )
  ...
  METHOD header_container_control.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `backgroundDesign` v = backgrounddesign )
                                   ( n = `gridLayout` v = zjbui5_cl_util=>boolean_abap_2_json( gridlayout ) )
                                   ( n = `height` v = height )
                                   ( n = `orientation` v = orientation )
                                   ( n = `scrollStep` v = scrollstep )
                                   ( n = `scrollStepByItem` v = scrollstepbyitem )
                                   ( n = `scrollTime` v = scrolltime )
                                   ( n = `showDividers` v = zjbui5_cl_util=>boolean_abap_2_json( showdividers ) )
                                   ( n = `showOverflowItem` v = zjbui5_cl_util=>boolean_abap_2_json( showoverflowitem ) )
                                   ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `snapToRow ` v = zjbui5_cl_util=>boolean_abap_2_json( snaptorow ) )
                                   ( n = `width` v = width )
                                   ( n = `id` v = id )
                                   ( n = `scroll` v = scroll ) ) ).
  ENDMETHOD.
  ...
  METHOD horizontal_layout.
    result = _generic(
                 ...
                 ns     = `layout`
                 t_prop = VALUE #( ( n = `class`  v = class )
                                   ( n = `allowWrapping`  v = zjbui5_cl_util=>boolean_abap_2_json( allowwrapping ) )
                                   ( n = `id`  v = id )
                                   ( n = `visible`  v = visible ) ) ).
  ENDMETHOD.
  ...
  METHOD html.
    ...
    result = _generic( name   = `HTML`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = 'preferDOM' v = zjbui5_cl_util=>boolean_abap_2_json( preferdom ) )
                           ( n = 'sanitizeContent' v = zjbui5_cl_util=>boolean_abap_2_json( sanitizecontent ) )
                           ( n = 'visible' v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD icon.
    ...
    _generic( name   = `Icon`
              ...
              t_prop = VALUE #( ( n = `size`  v = size )
                                ...
                                ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `decorative`  v = zjbui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `noTabStop`  v = zjbui5_cl_util=>boolean_abap_2_json( notabstop ) )
                                ( n = `useIconTooltip`  v = zjbui5_cl_util=>boolean_abap_2_json( useicontooltip ) ) ) ).
  ...
  METHOD icon_tab_bar.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `select`      v = select )
                     ( n = `expand`      v = expand )
                     ( n = `expandable`  v = zjbui5_cl_util=>boolean_abap_2_json( expandable ) )
                     ( n = `expanded`    v = zjbui5_cl_util=>boolean_abap_2_json( expanded ) )
                     ( n = `applyContentPadding`    v = zjbui5_cl_util=>boolean_abap_2_json( applycontentpadding ) )
                     ( n = `backgroundDesign`    v = backgrounddesign )
                     ( n = `enableTabReordering`    v = zjbui5_cl_util=>boolean_abap_2_json( enabletabreordering ) )
                     ( n = `headerBackgroundDesign`    v = headerbackgrounddesign )
                     ( n = `stretchContentHeight`    v = zjbui5_cl_util=>boolean_abap_2_json( stretchcontentheight ) )
                     ...
                     ( n = `id`    v = id )
                     ( n = `content`    v = content )
                     ( n = `upperCase`    v = zjbui5_cl_util=>boolean_abap_2_json( uppercase ) )
                     ( n = `selectedKey` v = selectedkey ) ) ).
  ENDMETHOD.
  ...
  METHOD icon_tab_filter.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `icon`        v = icon )
                          ...
                          ( n = `showAll`     v = zjbui5_cl_util=>boolean_abap_2_json( showall ) )
                          ( n = `iconDensityAware`     v = zjbui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                          ( n = `visible`     v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `count`       v = count )
                          ( n = `text`        v = text )
  ...
  METHOD illustrated_message.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enableFormattedText`             v = zjbui5_cl_util=>boolean_abap_2_json( enableformattedtext ) )
  ...
  METHOD image.
    ...
    _generic( name   = `Image`
              t_prop = VALUE #( ( n = `id` v = id )
                                ...
                                ( n = `load` v = load )
                                ( n = `decorative` v = zjbui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `densityAware` v = zjbui5_cl_util=>boolean_abap_2_json( densityaware ) )
                                ( n = `lazyLoading` v = zjbui5_cl_util=>boolean_abap_2_json( lazyloading ) ) ) ).
  ENDMETHOD.
  ...
  METHOD input.
    ...
    _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enabled`          v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
            ( n = `visible`          v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
            ( n = `enableTableAutoPopinMode` v = zjbui5_cl_util=>boolean_abap_2_json( enabletableautopopinmode ) )
            ( n = `enableSuggestionsHighlighting`  v = zjbui5_cl_util=>boolean_abap_2_json( enablesuggestionshighlighting ) )
            ( n = `showTableSuggestionValueHelp`   v = zjbui5_cl_util=>boolean_abap_2_json( showtablesuggestionvaluehelp ) )
            ( n = `valueState`       v = valuestate )
            ( n = `valueStateText`   v = valuestatetext )
            ( n = `value`            v = value )
            ( n = `required`          v = zjbui5_cl_util=>boolean_abap_2_json( required ) )
            ...
            ( n = `showSuggestion`   v = zjbui5_cl_util=>boolean_abap_2_json( showsuggestion ) )
            ( n = `valueHelpRequest` v = valuehelprequest )
            ( n = `autocomplete`     v = zjbui5_cl_util=>boolean_abap_2_json( autocomplete ) )
            ( n = `valueLiveUpdate`  v = zjbui5_cl_util=>boolean_abap_2_json( valueliveupdate ) )
            ( n = `submit`           v = zjbui5_cl_util=>boolean_abap_2_json( submit ) )
            ( n = `showValueHelp`    v = zjbui5_cl_util=>boolean_abap_2_json( showvaluehelp ) )
            ( n = `valueHelpOnly`    v = zjbui5_cl_util=>boolean_abap_2_json( valuehelponly ) )
            ( n = `class`            v = class )
            ( n = `change`            v = change )
  ...
  METHOD interact_bar_chart.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `selectionChanged`  v = selectionchanged )
                          ( n = `selectionEnabled`  v = zjbui5_cl_util=>boolean_abap_2_json( selectionenabled ) )
                          ( n = `showError`         v = zjbui5_cl_util=>boolean_abap_2_json( showerror ) )
                          ( n = `press`             v = press )
  ...
  METHOD label.
    ...
    _generic( name   = `Label`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ( n = `displayOnly`   v = zjbui5_cl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `required`   v = zjbui5_cl_util=>boolean_abap_2_json( required ) )
                                ( n = `showColon`   v = zjbui5_cl_util=>boolean_abap_2_json( showcolon ) )
                                ( n = `textAlign`   v = textalign )
                                ( n = `textDirection`   v = textdirection )
                                ( n = `vAlign`   v = valign )
                                ( n = `width`   v = width )
  ...
  METHOD layered_layout.
    result = _generic( name   = `LayeredLayout`
                       ...
                       t_prop = VALUE #( ( n = `id`  v = id )
                                         ...
                                         ( n = `mergeEdges`  v = zjbui5_cl_util=>boolean_abap_2_json( mergeedges ) ) ) ).
  ENDMETHOD.
  ...
  METHOD library_shape.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`       v = id )
                          ( n = `class`    v = class )
                          ( n = `animationOnChange`     v = zjbui5_cl_util=>boolean_abap_2_json( animationonchange ) )
  ...
  METHOD line.
    ...
    result = _generic( name   = `Line`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `hover`        v = hover )
                           ( n = `press`        v = press )
                           ( n = `stretchToCenter`           v = zjbui5_cl_util=>boolean_abap_2_json( stretchtocenter ) )
                           ( n = `selected`           v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                           ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD line_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `color`  v = color )
                          ...
                          ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `showBottomLabels`    v = zjbui5_cl_util=>boolean_abap_2_json( showbottomlabels ) )
                          ( n = `showPoints`    v = zjbui5_cl_util=>boolean_abap_2_json( showpoints ) )
                          ( n = `showThresholdLine`    v = zjbui5_cl_util=>boolean_abap_2_json( showthresholdline ) )
                          ( n = `showThresholdValue`    v = zjbui5_cl_util=>boolean_abap_2_json( showthresholdvalue ) )
                          ( n = `showTopLabels`    v = zjbui5_cl_util=>boolean_abap_2_json( showtoplabels ) )
                          ( n = `maxYValue`  v = maxyvalue ) ) ).
  ENDMETHOD.
  ...
  METHOD line_micro_chart_empszd_point.
    result = _generic( name   = `LineMicroChartEmphasizedPoint`
                       ...
                       t_prop = VALUE #( ( n = `x`       v = x )
                                         ( n = `y`       v = y )
                                         ( n = `color`       v = color )
                                         ( n = `show`       v = zjbui5_cl_util=>boolean_abap_2_json( show ) )
                                       ) ).
  ENDMETHOD.
  ...
  METHOD link.
    ...
    _generic( name   = `Link`
              ...
              t_prop = VALUE #( ( n = `text`    v = text )
                                ...
                                ( n = `emptyIndicatorMode`      v = emptyindicatormode )
                                ( n = `rel`      v = rel )
                                ( n = `subtle`      v = zjbui5_cl_util=>boolean_abap_2_json( subtle ) )
                                ( n = `textAlign`      v = textalign )
                                ( n = `textDirection`      v = textdirection )
                                ( n = `validateUrl`      v = zjbui5_cl_util=>boolean_abap_2_json( validateurl ) )
                                ( n = `width`      v = width )
                                ( n = `wrapping`      v = zjbui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `emphasized`      v = zjbui5_cl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `enabled` v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `endIcon` v = endicon )
                                ( n = `icon`    v = icon ) ) ).
  ENDMETHOD.
  ...
  METHOD map_container.
    ...
    result = _generic( name   = `MapContainer`
                       ...
                       t_prop = VALUE #(
                           ( n = `id`  v = id )
                           ( n = `autoAdjustHeight`  v = zjbui5_cl_util=>boolean_abap_2_json( autoadjustheight ) )
                           ( n = `showHome`  v = zjbui5_cl_util=>boolean_abap_2_json( showhome ) ) ) ).
  ...
  METHOD message_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `type`                v = type )
                          ...
                          ( n = `textDirection`       v = textdirection )
                          ( n = `groupName`           v = groupname )
                          ( n = `activeTitle`         v = zjbui5_cl_util=>boolean_abap_2_json( activetitle ) )
                          ( n = `counter`             v = counter )
                          ( n = `markupDescription`   v = zjbui5_cl_util=>boolean_abap_2_json( markupdescription ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_page.
    result = _generic(
                 name   = `MessagePage`
                 t_prop = VALUE #(
                     ( n = `showHeader`          v = zjbui5_cl_util=>boolean_abap_2_json( show_header ) )
                     ( n = `description`         v = description )
                     ( n = `icon`                v = icon )
                     ( n = `text`                v = text )
                     ( n = `enableFormattedText` v = zjbui5_cl_util=>boolean_abap_2_json( enableformattedtext ) ) ) ).
  ...
  METHOD message_popover.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `items`             v = items )
                          ...
                          ( n = `afterClose`        v = afterclose )
                          ( n = `beforeClose`       v = beforeclose )
                          ( n = `initiallyExpanded` v = zjbui5_cl_util=>boolean_abap_2_json( initiallyexpanded ) )
                          ( n = `groupItems`        v = zjbui5_cl_util=>boolean_abap_2_json( groupitems ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_strip.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `text`     v = text )
                          ...
                          ( n = `customIcon`       v = customicon )
                          ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `showCloseButton`  v = zjbui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
                          ( n = `class`    v = class )
                          ( n = `enableFormattedText`    v = zjbui5_cl_util=>boolean_abap_2_json( enableformattedtext ) ) ) ).
  ENDMETHOD.
  ...
  METHOD micro_process_flow_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`       v = id )
                          ...
                          ( n = `key`    v = key )
                          ( n = `icon`    v = icon )
                          ( n = `showSeparator`    v = zjbui5_cl_util=>boolean_abap_2_json( showseparator ) )
                          ( n = `showIntermediary`    v = zjbui5_cl_util=>boolean_abap_2_json( showintermediary ) )
                       ) ).
  ENDMETHOD.
  ...
  METHOD network_graph.
    result = _generic( name   = `Graph`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `enableWheelZoom`           v = zjbui5_cl_util=>boolean_abap_2_json( enablewheelzoom ) )
                           ( n = `enableZoom`           v = zjbui5_cl_util=>boolean_abap_2_json( enablezoom ) )
                           ( n = `noData`           v = zjbui5_cl_util=>boolean_abap_2_json( nodata ) )
                           ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD node.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `hover` v = hover )
            ( n = `press` v = press )
            ( n = `collapsed`           v = zjbui5_cl_util=>boolean_abap_2_json( collapsed ) )
            ( n = `selected`           v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
            ( n = `showActionLinksButton`           v = zjbui5_cl_util=>boolean_abap_2_json( showactionlinksbutton ) )
            ( n = `showDetailButton`           v = zjbui5_cl_util=>boolean_abap_2_json( showdetailbutton ) )
            ( n = `showExpandButton`           v = zjbui5_cl_util=>boolean_abap_2_json( showexpandbutton ) )
            ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD notification_list_group.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                     ( n = `autoPriority`           v = zjbui5_cl_util=>boolean_abap_2_json( autopriority ) )
                     ( n = `collapsed`           v = zjbui5_cl_util=>boolean_abap_2_json( collapsed ) )
                     ( n = `enableCollapseButtonWhenEmpty`
                       v = zjbui5_cl_util=>boolean_abap_2_json( enablecollapsebuttonwhenempty ) )
                     ( n = `navigated`           v = zjbui5_cl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                     ( n = `showButtons`           v = zjbui5_cl_util=>boolean_abap_2_json( showbuttons ) )
                     ( n = `showCloseButton`           v = zjbui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
                     ( n = `showEmptyGroup`           v = zjbui5_cl_util=>boolean_abap_2_json( showemptygroup ) )
                     ( n = `showItemsCounter`           v = zjbui5_cl_util=>boolean_abap_2_json( showitemscounter ) )
                     ( n = `unread`           v = zjbui5_cl_util=>boolean_abap_2_json( unread ) ) ) ).
  ENDMETHOD.
  ...
  METHOD notification_list_item.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `press`  v = press )
                     ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                     ( n = `hideShowMoreButton`           v = zjbui5_cl_util=>boolean_abap_2_json( hideshowmorebutton ) )
                     ( n = `truncate`           v = zjbui5_cl_util=>boolean_abap_2_json( truncate ) )
                     ( n = `highlight`           v = zjbui5_cl_util=>boolean_abap_2_json( highlight ) )
                     ( n = `navigated`           v = zjbui5_cl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                     ( n = `showButtons`           v = zjbui5_cl_util=>boolean_abap_2_json( showbuttons ) )
                     ( n = `showCloseButton`           v = zjbui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
  ...
  METHOD numeric_content.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `value`      v = value )
                          ...
                          ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `nullifyValue` v = zjbui5_cl_util=>boolean_abap_2_json( nullifyvalue ) )
                          ( n = `formatterValue` v = zjbui5_cl_util=>boolean_abap_2_json( formattervalue ) )
                          ( n = `animateTextChange` v = zjbui5_cl_util=>boolean_abap_2_json( animatetextchange ) )
                          ( n = `adaptiveFontSize` v = zjbui5_cl_util=>boolean_abap_2_json( adaptivefontsize ) )
                          ( n = `withMargin` v = zjbui5_cl_util=>boolean_abap_2_json( withmargin ) )
                          ( n = `class`      v = class )
                          ( n = `press`      v = press ) ) ).
  ...
  METHOD numeric_header.
    ...
    result = _generic( name   = `NumericHeader`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `statusVisible`           v = zjbui5_cl_util=>boolean_abap_2_json( statusvisible ) )
                           ( n = `numberVisible`           v = zjbui5_cl_util=>boolean_abap_2_json( numbervisible ) )
                           ( n = `iconVisible`           v = zjbui5_cl_util=>boolean_abap_2_json( iconvisible ) )
                           ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD object_header.
    ...
    result = _generic(
        name   = `ObjectHeader`
        t_prop = VALUE #( ( n = `backgrounddesign`     v = backgrounddesign )
                          ( n = `condensed`            v = zjbui5_cl_util=>boolean_abap_2_json( condensed ) )
                          ( n = `fullscreenoptimized`  v = zjbui5_cl_util=>boolean_abap_2_json( fullscreenoptimized ) )
                          ( n = `icon`                 v = icon )
                          ( n = `iconactive`           v = zjbui5_cl_util=>boolean_abap_2_json( iconactive ) )
                          ( n = `iconalt`              v = iconalt )
                          ( n = `icondensityaware`     v = zjbui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                          ...
                          ( n = `intro`                v = intro )
                          ( n = `introactive`          v = zjbui5_cl_util=>boolean_abap_2_json( introactive ) )
                          ...
                          ( n = `responsive`           v = zjbui5_cl_util=>boolean_abap_2_json( responsive ) )
                          ( n = `showtitleselector`    v = zjbui5_cl_util=>boolean_abap_2_json( showtitleselector ) )
                          ( n = `title`                v = title )
                          ( n = `titleactive`          v = zjbui5_cl_util=>boolean_abap_2_json( titleactive ) )
  ...
  METHOD object_number.
    ...
    _generic( name   = `ObjectNumber`
              t_prop = VALUE #( ( n = `emphasized`         v = zjbui5_cl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `number`             v = number )
                                ( n = `state`              v = state )
                                ( n = `id`          v = id )
                                ( n = `class`          v = class )
                                ...
                                ( n = `numberunit`         v = numberunit )
                                ( n = `active`             v = zjbui5_cl_util=>boolean_abap_2_json( active ) )
                                ( n = `inverted`           v = zjbui5_cl_util=>boolean_abap_2_json( inverted ) )
                                ( n = `visible`            v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `unit`               v = unit ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_header.
    ...
    _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `isActionAreaAlwaysVisible`  v = zjbui5_cl_util=>boolean_abap_2_json( isactionareaalwaysvisible ) )
            ( n = `isObjectIconAlwaysVisible`       v = zjbui5_cl_util=>boolean_abap_2_json( isobjecticonalwaysvisible ) )
            ( n = `isObjectSubtitleAlwaysVisible`
              v = zjbui5_cl_util=>boolean_abap_2_json( isobjectsubtitlealwaysvisible ) )
            ( n = `isObjectTitleAlwaysVisible`       v = zjbui5_cl_util=>boolean_abap_2_json( isobjecttitlealwaysvisible ) )
            ( n = `markChanges`       v = zjbui5_cl_util=>boolean_abap_2_json( markchanges ) )
            ( n = `markFavorite`       v = zjbui5_cl_util=>boolean_abap_2_json( markfavorite ) )
            ( n = `markFlagged`       v = zjbui5_cl_util=>boolean_abap_2_json( markflagged ) )
            ( n = `markLocked`       v = zjbui5_cl_util=>boolean_abap_2_json( marklocked ) )
            ( n = `objectImageDensityAware`       v = zjbui5_cl_util=>boolean_abap_2_json( objectimagedensityaware ) )
            ( n = `showMarkers`       v = zjbui5_cl_util=>boolean_abap_2_json( showmarkers ) )
            ( n = `showPlaceholder`       v = zjbui5_cl_util=>boolean_abap_2_json( showplaceholder ) )
            ( n = `showTitleSelector`       v = zjbui5_cl_util=>boolean_abap_2_json( showtitleselector ) )
            ( n = `visible`       v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD object_page_header_action_btn.
    ...
    _generic( name   = `ObjectPageHeaderActionButton`
              ...
              t_prop = VALUE #( ( n = `activeIcon`  v = activeicon )
                                ...
                                ( n = `width`      v = width )
                                ( n = `enabled`    v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `hideIcon`    v = zjbui5_cl_util=>boolean_abap_2_json( hideicon ) )
                                ( n = `hideText`    v = zjbui5_cl_util=>boolean_abap_2_json( hidetext ) )
                                ( n = `iconDensityAware`    v = zjbui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst`    v = zjbui5_cl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `visible`    v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `press`  v = press ) ) ).
  ...
  METHOD object_page_layout.
    result = _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `showTitleInHeaderContent` v = zjbui5_cl_util=>boolean_abap_2_json( showtitleinheadercontent ) )
            ( n = `showEditHeaderButton`     v = zjbui5_cl_util=>boolean_abap_2_json( showeditheaderbutton ) )
            ( n = `alwaysShowContentHeader`     v = zjbui5_cl_util=>boolean_abap_2_json( alwaysshowcontentheader ) )
            ( n = `enableLazyLoading`     v = zjbui5_cl_util=>boolean_abap_2_json( enablelazyloading ) )
            ( n = `flexEnabled`     v = zjbui5_cl_util=>boolean_abap_2_json( flexenabled ) )
            ( n = `headerContentPinnable`     v = zjbui5_cl_util=>boolean_abap_2_json( headercontentpinnable ) )
            ( n = `headerContentPinned`     v = zjbui5_cl_util=>boolean_abap_2_json( headercontentpinned ) )
            ( n = `isChildPage`     v = zjbui5_cl_util=>boolean_abap_2_json( ischildpage ) )
            ( n = `preserveHeaderStateOnScroll`     v = zjbui5_cl_util=>boolean_abap_2_json( preserveheaderstateonscroll ) )
            ( n = `showAnchorBar`     v = zjbui5_cl_util=>boolean_abap_2_json( showanchorbar ) )
            ( n = `showAnchorBarPopover`     v = zjbui5_cl_util=>boolean_abap_2_json( showanchorbarpopover ) )
            ( n = `showHeaderContent`     v = zjbui5_cl_util=>boolean_abap_2_json( showheadercontent ) )
            ( n = `showOnlyHighImportance`     v = zjbui5_cl_util=>boolean_abap_2_json( showonlyhighimportance ) )
            ( n = `subSectionLayout`     v = subsectionlayout )
            ( n = `toggleHeaderOnTitleClick`     v = zjbui5_cl_util=>boolean_abap_2_json( toggleheaderontitleclick ) )
            ( n = `useIconTabBar`     v = zjbui5_cl_util=>boolean_abap_2_json( useicontabbar ) )
            ( n = `useTwoColumnsForLargeScreen`     v = zjbui5_cl_util=>boolean_abap_2_json( usetwocolumnsforlargescreen ) )
            ( n = `visible`     v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
            ...
            ( n = `upperCaseAnchorBar`       v = zjbui5_cl_util=>boolean_abap_2_json( uppercaseanchorbar ) )
  ...
  METHOD object_page_section.
    result = _generic(
                 ...
                 ns     = `uxap`
                 t_prop = VALUE #( ( n = `titleUppercase`  v = zjbui5_cl_util=>boolean_abap_2_json( titleuppercase ) )
                                   ( n = `title`           v = title )
                                   ( n = `id`              v = id )
                                   ( n = `anchorBarButtonColor`              v = anchorbarbuttoncolor )
                                   ( n = `titleLevel`      v = titlelevel )
                                   ( n = `titleVisible`       v = zjbui5_cl_util=>boolean_abap_2_json( titlevisible ) )
                                   ( n = `showTitle`       v = zjbui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                   ( n = `visible`       v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `wrapTitle`       v = zjbui5_cl_util=>boolean_abap_2_json( wraptitle ) )
                                   ( n = `importance`      v = importance ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_sub_section.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`    v = id )
                                   ...
                                   ( n = `titleVisible`    v = zjbui5_cl_util=>boolean_abap_2_json( titlevisible ) )
                                   ( n = `showTitle`    v = zjbui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                   ( n = `titleUppercase`    v = zjbui5_cl_util=>boolean_abap_2_json( titleuppercase ) )
                                   ( n = `visible`    v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `title` v = title ) ) ).
  ENDMETHOD.
  ...
  METHOD object_status.
    result = _generic(
        name   = `ObjectStatus`
        t_prop = VALUE #( ( n = `active`                v = zjbui5_cl_util=>boolean_abap_2_json( active ) )
                          ( n = `emptyIndicatorMode`    v = emptyindicatormode )
                          ( n = `icon`                  v = icon )
                          ( n = `iconDensityAware`      v = zjbui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                          ( n = `inverted`              v = zjbui5_cl_util=>boolean_abap_2_json( inverted ) )
  ...
  METHOD overflow_toolbar.
    result = _generic( name   = `OverflowToolbar`
                       t_prop = VALUE #( ( n = `press`   v = press )
                                         ...
                                         ( n = `active` v = zjbui5_cl_util=>boolean_abap_2_json( active ) )
                                         ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `asyncMode` v = zjbui5_cl_util=>boolean_abap_2_json( asyncmode ) )
                                         ( n = `enabled` v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `design`    v = design )
                                         ( n = `type`    v = type )
                                         ( n = `style`    v = style )
  ...
  METHOD page.
    result = _generic(
                 ...
                 ns     = ns
                 t_prop = VALUE #( ( n = `title` v = title )
                                   ( n = `showNavButton`  v = zjbui5_cl_util=>boolean_abap_2_json( shownavbutton ) )
                                   ( n = `navButtonPress` v = navbuttonpress )
                                   ( n = `showHeader` v = zjbui5_cl_util=>boolean_abap_2_json( showheader ) )
                                   ( n = `class` v = class )
                                   ( n = `backgroundDesign` v = backgrounddesign )
                                   ( n = `navButtonTooltip` v = navbuttontooltip )
                                   ( n = `titleAlignment` v = titlealignment )
                                   ( n = `titleLevel` v = titlelevel )
                                   ( n = `contentOnlyBusy` v = zjbui5_cl_util=>boolean_abap_2_json( contentonlybusy ) )
                                   ( n = `enableScrolling` v = zjbui5_cl_util=>boolean_abap_2_json( enablescrolling ) )
                                   ( n = `floatingFooter` v = zjbui5_cl_util=>boolean_abap_2_json( floatingfooter ) )
                                   ( n = `showFooter` v = zjbui5_cl_util=>boolean_abap_2_json( showfooter ) )
                                   ( n = `showSubHeader` v = zjbui5_cl_util=>boolean_abap_2_json( showsubheader ) )
                                   ( n = `id` v = id ) ) ).
  ENDMETHOD.
  ...
  METHOD panel.
    ...
    result = _generic(
                 name   = `Panel`
                 t_prop = VALUE #( ( n = `expandable` v = zjbui5_cl_util=>boolean_abap_2_json( expandable ) )
                                   ( n = `expanded`   v = zjbui5_cl_util=>boolean_abap_2_json( expanded ) )
                                   ( n = `stickyHeader`   v = zjbui5_cl_util=>boolean_abap_2_json( stickyheader ) )
                                   ( n = `expandAnimation`   v = zjbui5_cl_util=>boolean_abap_2_json( expandanimation ) )
                                   ( n = `visible`   v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `height`   v = height )
                                   ( n = `backgroundDesign`   v = backgrounddesign )
                                   ( n = `width`   v = width )
  ...
  METHOD planning_calendar.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `viewKey`         v = viewkey )
            ( n = `width`         v = width )
            ( n = `singleSelection`  v = zjbui5_cl_util=>boolean_abap_2_json( singleselection ) )
            ( n = `showRowHeaders`  v = zjbui5_cl_util=>boolean_abap_2_json( showrowheaders ) )
            ( n = `multipleAppointmentsSelection`  v = zjbui5_cl_util=>boolean_abap_2_json( multipleappointmentsselection ) )
            ( n = `showIntervalHeaders`  v = zjbui5_cl_util=>boolean_abap_2_json( showintervalheaders ) )
            ( n = `showEmptyIntervalHeaders`  v = zjbui5_cl_util=>boolean_abap_2_json( showemptyintervalheaders ) )
            ( n = `showWeekNumbers`           v = zjbui5_cl_util=>boolean_abap_2_json( showweeknumbers ) )
            ( n = `legend`                    v = legend )
            ( n = `showDayNamesLine`          v = zjbui5_cl_util=>boolean_abap_2_json( showdaynamesline ) ) ) ).
  ENDMETHOD.
  ...
  METHOD planning_calendar_row.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enableAppointmentsCreate`        v = zjbui5_cl_util=>boolean_abap_2_json( enableappointmentscreate ) )
            ...
            ( n = `selected`                        v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
            ( n = `nonWorkingDays`                  v = nonworkingdays )
            ( n = `enableAppointmentsResize`        v = zjbui5_cl_util=>boolean_abap_2_json( enableappointmentsresize ) )
            ( n = `enableAppointmentsDragAndDrop`
              v = zjbui5_cl_util=>boolean_abap_2_json( enableappointmentsdraganddrop ) )
            ( n = `text`                            v = text )
                        ) ).
  ...
  METHOD planning_calendar_view.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `appointmentHeight`                      v = appointmentheight )
                          ...
                          ( n = `key`  v = key )
                          ( n = `relative`  v = zjbui5_cl_util=>boolean_abap_2_json( relative ) )
                          ( n = `showSubIntervals`  v = zjbui5_cl_util=>boolean_abap_2_json( showsubintervals ) )
                        ) ).
  ENDMETHOD.
  ...
  METHOD popover.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`         v = id )
                          ...
                          ( n = `contentHeight` v = contentheight )
                          ( n = `showHeader`    v = zjbui5_cl_util=>boolean_abap_2_json( showheader ) )
                          ( n = `showArrow`    v = zjbui5_cl_util=>boolean_abap_2_json( showarrow ) )
                          ( n = `resizable`    v = zjbui5_cl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `modal`    v = zjbui5_cl_util=>boolean_abap_2_json( modal ) )
                          ( n = `horizontalScrolling`    v = zjbui5_cl_util=>boolean_abap_2_json( horizontalscrolling ) )
                          ( n = `verticalScrolling`    v = zjbui5_cl_util=>boolean_abap_2_json( verticalscrolling ) )
                          ( n = `visible`    v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `offsetX`    v = offsetx )
  ...
  METHOD process_flow.
    result = _generic(
                 ...
                 ns     = 'commons'
                 t_prop = VALUE #( ( n = `id`               v = id )
                                   ( n = `foldedCorners`    v = zjbui5_cl_util=>boolean_abap_2_json( foldedcorners ) )
                                   ( n = `scrollable`       v = zjbui5_cl_util=>boolean_abap_2_json( scrollable ) )
                                   ( n = `showLabels`       v = zjbui5_cl_util=>boolean_abap_2_json( showlabels ) )
                                   ( n = `visible`          v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `wheelZoomable`    v = zjbui5_cl_util=>boolean_abap_2_json( wheelzoomable ) )
  ...
  METHOD process_flow_node.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `laneId`               v = laneid )
                                   ...
                                   ( n = `texts`                v = texts )
                                   ( n = `highlighted`          v = zjbui5_cl_util=>boolean_abap_2_json( highlighted ) )
                                   ( n = `focused`              v = zjbui5_cl_util=>boolean_abap_2_json( focused ) )
                                   ( n = `selected`             v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                                   ( n = `tag`                  v = tag )
                                   ( n = `texts`                v = texts )
                                   ( n = `type`                 v = type ) ) ).
  ...
  METHOD progress_indicator.
    ...
    _generic( name   = `ProgressIndicator`
              t_prop = VALUE #( ( n = `class`        v = class )
                                ...
                                ( n = `displayValue` v = displayvalue )
                                ( n = `showValue`    v = zjbui5_cl_util=>boolean_abap_2_json( showvalue ) )
                                ( n = `visible`      v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `state`        v = state ) ) ).
  ENDMETHOD.
...
*              ns     = `webc`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `showTickmarks`   v = zjbui5_cl_util=>boolean_abap_2_json( showtickmarks ) )
  ...
  METHOD rich_text_editor.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `buttonGroups`        v = buttongroups )
                          ( n = `customToolbar`       v = zjbui5_cl_util=>boolean_abap_2_json( customtoolbar ) )
                          ( n = `editable`            v = zjbui5_cl_util=>boolean_abap_2_json( editable ) )
                          ( n = `height`              v = height )
                          ...
                          ( n = `required`            v = zjbui5_cl_util=>boolean_abap_2_json( required ) )
                          ( n = `sanitizeValue`       v = zjbui5_cl_util=>boolean_abap_2_json( sanitizevalue ) )
                          ( n = `showGroupClipboard`  v = zjbui5_cl_util=>boolean_abap_2_json( showgroupclipboard ) )
                          ( n = `showGroupFont`       v = zjbui5_cl_util=>boolean_abap_2_json( showgroupfont ) )
                          ( n = `showGroupFontStyle`  v = zjbui5_cl_util=>boolean_abap_2_json( showgroupfontstyle ) )
                          ( n = `showGroupInsert`     v = zjbui5_cl_util=>boolean_abap_2_json( showgroupinsert ) )
                          ( n = `showGroupLink`       v = zjbui5_cl_util=>boolean_abap_2_json( showgrouplink ) )
                          ( n = `showGroupStructure`  v = zjbui5_cl_util=>boolean_abap_2_json( showgroupstructure ) )
                          ( n = `showGroupTextAlign`  v = zjbui5_cl_util=>boolean_abap_2_json( showgrouptextalign ) )
                          ( n = `showGroupUndo`       v = zjbui5_cl_util=>boolean_abap_2_json( showgroupundo ) )
                          ( n = `useLegacyTheme`      v = zjbui5_cl_util=>boolean_abap_2_json( uselegacytheme ) )
                          ( n = `wrapping`            v = zjbui5_cl_util=>boolean_abap_2_json( wrapping ) )
                          ( n = `width`               v = width ) ) ).
  ...
  METHOD scroll_container.
    result = _generic( name   = `ScrollContainer`
                       t_prop = VALUE #( ( n = `height`      v = height )
                                         ...
                                         ( n = `id`          v = id )
                                         ( n = `visible`     v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `vertical`    v = zjbui5_cl_util=>boolean_abap_2_json( vertical ) )
                                         ( n = `horizontal`  v = zjbui5_cl_util=>boolean_abap_2_json( horizontal ) )
                                         ( n = `focusable`   v = zjbui5_cl_util=>boolean_abap_2_json( focusable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD search_field.
    ...
    _generic( name   = `SearchField`
              t_prop = VALUE #( ( n = `width`  v = width )
                                ...
                                ( n = `placeholder` v = placeholder )
                                ( n = `suggest` v = suggest )
                                ( n = `enableSuggestions` v = zjbui5_cl_util=>boolean_abap_2_json( enablesuggestions ) )
                                ( n = `showRefreshButton` v = zjbui5_cl_util=>boolean_abap_2_json( showrefreshbutton ) )
                                ( n = `showSearchButton` v = zjbui5_cl_util=>boolean_abap_2_json( showsearchbutton ) )
                                ( n = `visible` v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `enabled` v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `liveChange` v = livechange ) ) ).
  ENDMETHOD.
  ...
  METHOD select.
    result = _generic( name   = `Select`
                       t_prop = VALUE #(
                           ( n = `id`                  v = id )
                           ( n = `class`                  v = class )
                           ( n = `autoAdjustWidth`     v = zjbui5_cl_util=>boolean_abap_2_json( autoadjustwidth ) )
                           ( n = `columnRatio`         v = columnratio )
                           ( n = `editable`            v = zjbui5_cl_util=>boolean_abap_2_json( editable ) )
                           ( n = `enabled`             v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                           ( n = `forceSelection`      v = zjbui5_cl_util=>boolean_abap_2_json( forceselection ) )
                           ( n = `icon`                v = icon )
                           ( n = `maxWidth`            v = maxwidth )
                           ( n = `name`                v = name )
                           ( n = `required`            v = zjbui5_cl_util=>boolean_abap_2_json( required ) )
                           ( n = `resetOnMissingKey`   v = zjbui5_cl_util=>boolean_abap_2_json( resetonmissingkey ) )
                           ( n = `selectedItemId`      v = selecteditemid )
                           ( n = `selectedKey`         v = selectedkey )
                           ( n = `showSecondaryValues` v = zjbui5_cl_util=>boolean_abap_2_json( showsecondaryvalues ) )
                           ( n = `textAlign`           v = textalign )
                           ...
                           ( n = `valueStateText`      v = valuestatetext )
                           ( n = `width`               v = width )
                           ( n = `wrapItemsText`       v = zjbui5_cl_util=>boolean_abap_2_json( wrapitemstext ) )
                           ( n = `items`               v = items )
                           ( n = `selectedItem`        v = selecteditem )
                           ( n = `change`              v = change )
                           ( n = `liveChange`          v = livechange )
  ...
  METHOD shell.
    result = _generic(
        name   = `Shell`
        ns     = ns
        t_prop = VALUE #( ( n = `appWidthLimited`  v = zjbui5_cl_util=>boolean_abap_2_json( appwidthlimited ) ) ) ).
  ENDMETHOD.
  ...
  METHOD shell_bar.
    result = _generic( name   = `ShellBar`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `showCopilot`  v = zjbui5_cl_util=>boolean_abap_2_json( showcopilot ) )
                           ( n = `showMenuButton`  v = zjbui5_cl_util=>boolean_abap_2_json( showmenubutton ) )
                           ( n = `showNavButton`  v = zjbui5_cl_util=>boolean_abap_2_json( shownavbutton ) )
                           ( n = `showNotifications`  v = zjbui5_cl_util=>boolean_abap_2_json( shownotifications ) )
                           ( n = `showProductSwitcher`  v = zjbui5_cl_util=>boolean_abap_2_json( showproductswitcher ) )
                           ( n = `showSearch`  v = zjbui5_cl_util=>boolean_abap_2_json( showsearch ) )
  ...
  METHOD side_panel.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `sidePanelWidth`  v = sidepanelwidth )
                          ...
                          ( n = `sidePanelResizable`    v = zjbui5_cl_util=>boolean_abap_2_json( sidepanelresizable ) )
                          ( n = `actionBarExpanded`    v = zjbui5_cl_util=>boolean_abap_2_json( actionbarexpanded ) )
                          ( n = `toggle`    v = toggle )
                          ( n = `ariaLabel`  v = arialabel ) ) ).
  ENDMETHOD.
  ...
  METHOD simple_form.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `minWidth`   v = minwidth )
            ( n = `singleContainerFullSize`   v = zjbui5_cl_util=>boolean_abap_2_json( singlecontainerfullsize ) )
            ( n = `visible`   v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
            ( n = `width`       v = width )
            ( n = `id`       v = id )
  ...
  METHOD slider.
    ...
    _generic( name   = `Slider`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `enableTickmarks`   v = zjbui5_cl_util=>boolean_abap_2_json( enabletickmarks ) )
                                ( n = `enabled`   v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `value`   v = value )
                                ( n = `step`   v = step )
                                ( n = `change`   v = change )
  ...
  METHOD smart_variant_management.
    ...
    _generic(
        ...
        t_prop = VALUE #(
            ( n = `id`      v = id )
            ( n = `showExecuteOnSelection`  v = zjbui5_cl_util=>boolean_abap_2_json( showexecuteonselection ) )
            ( n = `persistencyKey`  v = persistencykey )
             ) ).
  ...
  METHOD stacked_bar_micro_chart.
    ...
    _generic( name   = `StackedBarMicroChart`
              ...
              t_prop = VALUE #( ( n = `height`  v = height )
                                ...
                                ( n = `size`      v = size )
                                ( n = `hideOnNoData`    v = zjbui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `displayZeroValue`    v = zjbui5_cl_util=>boolean_abap_2_json( displayzerovalue ) )
                                ( n = `showLabels`    v = zjbui5_cl_util=>boolean_abap_2_json( showlabels ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD standard_list_item.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `title`       v = title )
                          ...
                          ( n = `counter`     v = counter )
                          ( n = `activeIcon`     v = activeicon )
                          ( n = `adaptTitleSize`     v = zjbui5_cl_util=>boolean_abap_2_json( adapttitlesize ) )
                          ( n = `unread`     v = zjbui5_cl_util=>boolean_abap_2_json( unread ) )
                          ( n = `iconInset`     v = zjbui5_cl_util=>boolean_abap_2_json( iconinset ) )
                          ( n = `infoStateInverted`     v = zjbui5_cl_util=>boolean_abap_2_json( infostateinverted ) )
                          ( n = `wrapping`     v = zjbui5_cl_util=>boolean_abap_2_json( wrapping ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`  v = id )
                                   ...
                                   ( n = `useFocusColorAsContentColor`
                                     v = zjbui5_cl_util=>boolean_abap_2_json( usefocuscolorascontentcolor ) )
                                   ( n = `visible`           v = zjbui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD table.
    result = _generic( name   = `Table`
                       t_prop = VALUE #(
                           ...
                           ( n = `backgroundDesign`  v = backgrounddesign )
                           ( n = `visible`  v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                           ( n = `alternateRowColors`  v = zjbui5_cl_util=>boolean_abap_2_json( alternaterowcolors ) )
                           ( n = `fixedLayout`  v = zjbui5_cl_util=>boolean_abap_2_json( fixedlayout ) )
                           ( n = `showOverlay`  v = zjbui5_cl_util=>boolean_abap_2_json( showoverlay ) )
                           ( n = `autoPopinMode`  v = zjbui5_cl_util=>boolean_abap_2_json( autopopinmode ) ) ) ).
  ENDMETHOD.
  ...
  METHOD table_select_dialog.
    ...
    result = _generic( name   = `TableSelectDialog`
                       t_prop = VALUE #(
                           ...
                           ( n = `growing`              v = zjbui5_cl_util=>boolean_abap_2_json( growing ) )
                           ( n = `growingThreshold`     v = growingthreshold )
                           ( n = `multiSelect`          v = zjbui5_cl_util=>boolean_abap_2_json( multiselect ) )
                           ( n = `noDataText`           v = nodatatext )
                           ( n = `rememberSelections`   v = zjbui5_cl_util=>boolean_abap_2_json( rememberselections ) )
                           ( n = `resizable`            v = zjbui5_cl_util=>boolean_abap_2_json( resizable ) )
                           ( n = `searchPlaceholder`    v = searchplaceholder )
                           ( n = `showClearButton`      v = zjbui5_cl_util=>boolean_abap_2_json( showclearbutton ) )
                           ( n = `title`                v = title )
                           ( n = `titleAlignment`       v = titlealignment )
                           ( n = `items`                v = items )
                           ( n = `search`               v = search )
  ...
  METHOD tile_content.
    ...
    result = _generic( name   = `TileContent`
                       ...
                       t_prop = VALUE #( ( n = `unit`   v = unit )
                                         ...
                                         ( n = `state`   v = state )
                                         ( n = `disabled`   v = zjbui5_cl_util=>boolean_abap_2_json( disabled ) )
                                         ( n = `visible`   v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `footer` v = footer )
                                         ( n = `class` v = class ) ) ).
  ...
  METHOD timeline.
    ...
    result = _generic(
        ...
        ns     = 'commons'
        t_prop = VALUE #( ( n = 'id'                 v = id )
                          ( n = 'enableDoubleSided'  v = zjbui5_cl_util=>boolean_abap_2_json( enabledoublesided ) )
                          ( n = 'groupBy'            v = groupby )
                          ( n = 'growingThreshold'   v = growingthreshold )
                          ( n = 'filterTitle'        v = filtertitle )
                          ( n = 'sortOldestFirst'    v = zjbui5_cl_util=>boolean_abap_2_json( sortoldestfirst ) )
                          ( n = 'enableModelFilter'  v = zjbui5_cl_util=>boolean_abap_2_json( enablemodelfilter ) )
                          ( n = 'enableScroll'       v = zjbui5_cl_util=>boolean_abap_2_json( enablescroll ) )
                          ( n = 'forceGrowing'       v = zjbui5_cl_util=>boolean_abap_2_json( forcegrowing ) )
                          ( n = 'group'              v = zjbui5_cl_util=>boolean_abap_2_json( group ) )
                          ( n = 'lazyLoading'        v = zjbui5_cl_util=>boolean_abap_2_json( lazyloading ) )
                          ( n = 'showHeaderBar'      v = zjbui5_cl_util=>boolean_abap_2_json( showheaderbar ) )
                          ( n = 'showIcons'          v = zjbui5_cl_util=>boolean_abap_2_json( showicons ) )
                          ( n = 'showItemFilter'     v = zjbui5_cl_util=>boolean_abap_2_json( showitemfilter ) )
                          ( n = 'showSearch'         v = zjbui5_cl_util=>boolean_abap_2_json( showsearch ) )
                          ( n = 'showSort'           v = zjbui5_cl_util=>boolean_abap_2_json( showsort ) )
                          ( n = 'showTimeFilter'     v = zjbui5_cl_util=>boolean_abap_2_json( showtimefilter ) )
                          ( n = 'sort'               v = zjbui5_cl_util=>boolean_abap_2_json( sort ) )
  ...
  METHOD timeline_item.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = 'id'                     v = id )
                          ( n = 'dateTime'               v = datetime )
                          ( n = 'title'                  v = title )
                          ( n = 'userNameClickable'      v = zjbui5_cl_util=>boolean_abap_2_json( usernameclickable ) )
                          ( n = 'useIconTooltip'         v = zjbui5_cl_util=>boolean_abap_2_json( useicontooltip ) )
  ...
  METHOD time_picker.
    ...
    _generic( name   = `TimePicker`
              t_prop = VALUE #(
                  ...
                  ( n = `textDirection`  v = textdirection )
                  ( n = `title`  v = title )
                  ( n = `showCurrentTimeButton` v = zjbui5_cl_util=>boolean_abap_2_json( showcurrenttimebutton ) )
                  ( n = `showValueStateMessage` v = zjbui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                  ( n = `support2400` v = zjbui5_cl_util=>boolean_abap_2_json( support2400 ) )
                  ( n = `initialFocusedDateValue` v = zjbui5_cl_util=>boolean_abap_2_json( initialfocuseddatevalue ) )
                  ( n = `hideInput` v = zjbui5_cl_util=>boolean_abap_2_json( hideinput ) )
                  ( n = `editable` v = zjbui5_cl_util=>boolean_abap_2_json( editable ) )
                  ( n = `enabled` v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                  ( n = `required` v = zjbui5_cl_util=>boolean_abap_2_json( required ) )
  ...
  METHOD toggle_button.
    ...
    _generic( name   = `ToggleButton`
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `type`    v = type )
                                ( n = `class`   v = class )
                                ( n = `pressed` v = zjbui5_cl_util=>boolean_abap_2_json( pressed ) ) ) ).
  ENDMETHOD.
  ...
  METHOD tree_table.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enableColumnReordering`  v = zjbui5_cl_util=>boolean_abap_2_json( enablecolumnreordering ) )
                     ( n = `expandFirstLevel`        v = zjbui5_cl_util=>boolean_abap_2_json( expandfirstlevel ) )
                     ( n = `columnSelect`            v = columnselect )
                     ( n = `rowSelectionChange`      v = rowselectionchange )
                     ( n = `selectionBehavior`       v = selectionbehavior )
                     ( n = `id`                      v = id )
                     ( n = `alternateRowColors`      v = zjbui5_cl_util=>boolean_abap_2_json( alternaterowcolors ) )
                     ( n = `columnHeaderVisible`      v = zjbui5_cl_util=>boolean_abap_2_json( columnheadervisible ) )
                     ( n = `enableCellFilter`      v = zjbui5_cl_util=>boolean_abap_2_json( enablecellfilter ) )
                     ( n = `enableColumnFreeze`      v = zjbui5_cl_util=>boolean_abap_2_json( enablecolumnfreeze ) )
                     ( n = `enableCustomFilter`      v = zjbui5_cl_util=>boolean_abap_2_json( enablecustomfilter ) )
                     ( n = `enableSelectAll`      v = zjbui5_cl_util=>boolean_abap_2_json( enableselectall ) )
                     ( n = `showNoData`      v = zjbui5_cl_util=>boolean_abap_2_json( shownodata ) )
                     ( n = `showOverlay`      v = zjbui5_cl_util=>boolean_abap_2_json( showoverlay ) )
                     ( n = `visible`      v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                     ...
                     ( n = `threshold`           v = threshold )
                     ( n = `width`           v = width )
                     ( n = `useGroupMode`           v = zjbui5_cl_util=>boolean_abap_2_json( usegroupmode ) )
  ...
  METHOD ui_column.
    result = _generic( name   = `Column`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `autoresizable`  v = zjbui5_cl_util=>boolean_abap_2_json( autoresizable ) )
  ...
  METHOD ui_table.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `class`                     v = class )
            ( n = `enableCellFilter`          v = zjbui5_cl_util=>boolean_abap_2_json( enablecellfilter ) )
            ( n = `enableGrouping`            v = zjbui5_cl_util=>boolean_abap_2_json( enablegrouping ) )
            ( n = `enableSelectAll`           v = zjbui5_cl_util=>boolean_abap_2_json( enableselectall ) )
            ( n = `firstVisibleRow`           v = firstvisiblerow )
            ( n = `fixedBottomRowCount`       v = fixedbottomrowcount )
            ( n = `fixedColumnCount`          v = fixedcolumncount )
            ...
            ( n = `selectionMode`             v = selectionmode )
            ( n = `selectionBehavior`         v = selectionbehavior )
            ( n = `showColumnVisibilityMenu`  v = zjbui5_cl_util=>boolean_abap_2_json( showcolumnvisibilitymenu ) )
            ( n = `showNoData`                v = zjbui5_cl_util=>boolean_abap_2_json( shownodata ) )
            ( n = `threshold`                 v = threshold )
            ( n = `visibleRowCount`           v = visiblerowcount )
            ( n = `visibleRowCountMode`       v = visiblerowcountmode )
  ...
  METHOD upload_set.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ( n = `id`                       v = id )
                     ( n = `instantUpload`            v = zjbui5_cl_util=>boolean_abap_2_json( instantupload ) )
                     ( n = `showIcons`                v = zjbui5_cl_util=>boolean_abap_2_json( showicons ) )
                     ( n = `uploadEnabled`            v = zjbui5_cl_util=>boolean_abap_2_json( uploadenabled ) )
                     ( n = `terminationEnabled`       v = zjbui5_cl_util=>boolean_abap_2_json( terminationenabled ) )
                     ( n = `uploadButtonInvisible`    v = zjbui5_cl_util=>boolean_abap_2_json( uploadbuttoninvisible ) )
                     ...
                     ( n = `directory`                v = zjbui5_cl_util=>boolean_abap_2_json( directory ) )
                     ( n = `multiple`                 v = zjbui5_cl_util=>boolean_abap_2_json( multiple ) )
                     ...
                     ( n = `sameFilenameAllowed`      v = zjbui5_cl_util=>boolean_abap_2_json( samefilenameallowed ) )
  ...
  METHOD upload_set_item.
    result = _generic( name   = `UploadSetItem`
                       ...
                       t_prop = VALUE #( ( n = `fileName`      v = filename )
                                         ...
                                         ( n = `markers`       v = markers )
                                         ( n = `enabledEdit`   v = zjbui5_cl_util=>boolean_abap_2_json( enablededit ) )
                                         ( n = `enabledRemove` v = zjbui5_cl_util=>boolean_abap_2_json( enabledremove ) )
                                         ( n = `selected`      v = zjbui5_cl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `visibleEdit`   v = zjbui5_cl_util=>boolean_abap_2_json( visibleedit ) )
                                         ( n = `visibleRemove` v = zjbui5_cl_util=>boolean_abap_2_json( visibleremove ) )
  ...
  METHOD variant_item.
    ...
    result = _generic(
                 ...
                 ns     = `vm`
                 t_prop = VALUE #(
                     ( n = `executeOnSelection`      v = zjbui5_cl_util=>boolean_abap_2_json( executeonselection ) )
                     ( n = `global`                  v = zjbui5_cl_util=>boolean_abap_2_json( global ) )
                     ( n = `labelReadOnly`           v = zjbui5_cl_util=>boolean_abap_2_json( labelreadonly ) )
                     ...
                     ( n = `executeOnSelect`         v = zjbui5_cl_util=>boolean_abap_2_json( executeonselect ) )
                     ( n = `author`                  v = author )
                     ( n = `changeable`              v = zjbui5_cl_util=>boolean_abap_2_json( changeable ) )
                     ( n = `enabled`                 v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                     ( n = `favorite`                v = zjbui5_cl_util=>boolean_abap_2_json( favorite ) )
                     ( n = `key`                     v = key )
                     ( n = `text`                    v = text )
                     ( n = `title`                   v = title )
                     ( n = `textDirection`           v = textdirection )
                     ( n = `originalTitle`           v = originaltitle )
                     ( n = `originalExecuteOnSelect` v = zjbui5_cl_util=>boolean_abap_2_json( originalexecuteonselect ) )
                     ( n = `remove`                  v = zjbui5_cl_util=>boolean_abap_2_json( remove ) )
                     ( n = `rename`                  v = zjbui5_cl_util=>boolean_abap_2_json( rename ) )
                     ( n = `originalFavorite`        v = zjbui5_cl_util=>boolean_abap_2_json( originalfavorite ) )
                     ( n = `sharing`                 v = zjbui5_cl_util=>boolean_abap_2_json( sharing ) )
                     ( n = `change`                  v = change ) ) ).
  ...
  METHOD variant_management.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enabled`                v = zjbui5_cl_util=>boolean_abap_2_json( enabled ) )
                     ( n = `inErrorState`           v = zjbui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `initialSelectionKey`    v = initialselectionkey )
                     ( n = `lifecycleSupport`       v = zjbui5_cl_util=>boolean_abap_2_json( lifecyclesupport ) )
                     ( n = `selectionKey`           v = selectionkey )
                     ( n = `showCreateTile`         v = zjbui5_cl_util=>boolean_abap_2_json( showcreatetile ) )
                     ( n = `showExecuteOnSelection` v = zjbui5_cl_util=>boolean_abap_2_json( showexecuteonselection ) )
                     ( n = `showSetAsDefault`       v = zjbui5_cl_util=>boolean_abap_2_json( showsetasdefault ) )
                     ( n = `showShare`              v = zjbui5_cl_util=>boolean_abap_2_json( showshare ) )
                     ( n = `standardItemAuthor`     v = standarditemauthor )
                     ( n = `standardItemText`       v = standarditemtext )
                     ( n = `useFavorites`           v = zjbui5_cl_util=>boolean_abap_2_json( usefavorites ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `executeOnSelectionForStandardDefault`
                       v = zjbui5_cl_util=>boolean_abap_2_json( executeonselectionforstandflt ) )
                     ( n = `headerLevel`      v = headerlevel )
                     ( n = `inErrorState`      v = zjbui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `maxWidth`      v = maxwidth )
                     ( n = `modelName`      v = modelname )
                     ( n = `resetOnContextChange`      v = zjbui5_cl_util=>boolean_abap_2_json( resetoncontextchange ) )
                     ( n = `showSetAsDefault`      v = zjbui5_cl_util=>boolean_abap_2_json( showsetasdefault ) )
                     ( n = `titleStyle`      v = titlestyle )
                     ( n = `updateVariantInURL`    v = zjbui5_cl_util=>boolean_abap_2_json( updatevariantinurl ) )
                     ( n = `cancel`    v = cancel )
                     ( n = `initialized`    v = initialized )
                     ( n = `manage`    v = manage )
                     ( n = `save`    v = save )
  ...
  METHOD variant_management_sapm.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `select`    v = select )
            ( n = `items`    v = items )
            ( n = `creationAllowed`     v = zjbui5_cl_util=>boolean_abap_2_json( creationallowed ) )
            ( n = `inErrorState`     v = zjbui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
            ( n = `modified`     v = zjbui5_cl_util=>boolean_abap_2_json( modified ) )
            ( n = `showFooter`     v = zjbui5_cl_util=>boolean_abap_2_json( showfooter ) )
            ( n = `showSaveAs`     v = zjbui5_cl_util=>boolean_abap_2_json( showsaveas ) )
            ( n = `supportApplyAutomatically`     v = zjbui5_cl_util=>boolean_abap_2_json( supportapplyautomatically ) )
            ( n = `supportContexts`     v = zjbui5_cl_util=>boolean_abap_2_json( supportcontexts ) )
            ( n = `supportDefault`     v = zjbui5_cl_util=>boolean_abap_2_json( supportdefault ) )
            ( n = `supportFavorites`     v = zjbui5_cl_util=>boolean_abap_2_json( supportfavorites ) )
            ( n = `supportPublic`     v = zjbui5_cl_util=>boolean_abap_2_json( supportpublic ) )
            ( n = `visible`     v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
                        ) ).
  ...
  METHOD view_settings_dialog.
    ...
    result = _generic( name   = `ViewSettingsDialog`
                       t_prop = VALUE #(
                           ...
                           ( n = `groupDescending`          v = zjbui5_cl_util=>boolean_abap_2_json( groupdescending ) )
                           ( n = `sortDescending`           v = zjbui5_cl_util=>boolean_abap_2_json( sortdescending ) )
                           ( n = `title`                    v = title )
  ...
  METHOD wizard.
    result = _generic( name   = `Wizard`
                       t_prop = VALUE #(
                           ...
                           ( n = `busyIndicatorDelay`   v = busyindicatordelay )
                           ( n = `busyIndicatorSize`    v = busyindicatorsize )
                           ( n = `enableBranching`      v = zjbui5_cl_util=>boolean_abap_2_json( enablebranching ) )
                           ( n = `fieldGroupIds`        v = fieldgroupids )
                           ( n = `finishButtonText`     v = finishbuttontext )
                           ( n = `height`               v = height )
                           ( n = `renderMode`           v = rendermode )
                           ( n = `showNextButton`       v = zjbui5_cl_util=>boolean_abap_2_json( shownextbutton ) )
  ...
  METHOD wizard_step.
    ...
    result = _generic( name   = `WizardStep`
                       t_prop = VALUE #(
                           ...
                           (  n = `fieldGroupIds`        v = fieldgroupids )
                           (  n = `icon`                 v = icon )
                           (  n = `optional`             v = zjbui5_cl_util=>boolean_abap_2_json( optional ) )
                           (  n = `title`                v = title )
                           (  n = `validated`            v = zjbui5_cl_util=>boolean_abap_2_json( validated ) )
                           (  n = `visible`              v = zjbui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD xml_get.
    ...
    IF me = mo_root.
      ...
      DATA lt_prop TYPE HASHED TABLE OF zjbui5_if_types=>ty_s_name_value WITH UNIQUE KEY n.
      lt_prop = VALUE #(
          ( n = `z2ui5`             v = `z2ui5` )
...
*          ( n = `unified`           v = `sap.ui.unified` )
    ...
    LOOP AT mt_child INTO DATA(lr_child).
      result = result && CAST zjbui5_cl_xml_view( lr_child )->xml_get( ).
    ENDLOOP.
  ...
  METHOD _generic.
    ...
    DATA(result2) = NEW zjbui5_cl_xml_view( ).
  ...
  METHOD field.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`        v = id )
                          ...
                          ( n = `showEmptyIndicator`  v = zjbui5_cl_util=>boolean_abap_2_json( showemptyindicator ) ) ) ).
  ENDMETHOD.
  ...
  METHOD control_configuration.
    ...
    _generic( name             = `ControlConfiguration`
                        ...
                        t_prop = VALUE #( ( n = `id`  v = id )
                                          ( n = `key`  v = key )
                                          ( n = `visibleInAdvancedArea`  v = zjbui5_cl_util=>boolean_abap_2_json( visibleinadvancedarea ) )
                                          ( n = `preventInitialDataFetchInValueHelpDialog`  v = zjbui5_cl_util=>boolean_abap_2_json( previnitdatafetchinvalhelpdia ) )
                                          ) ).
  ...
  METHOD smart_table.
    ...
    result = _generic( name    = `SmartTable`
                        ...
                        ( n = `smartFilterId`  v = smartfilterid )
                                          ...
                                          ( n = `entitySet`  v = entityset )
                                          ( n = `useVariantManagement`  v = zjbui5_cl_util=>boolean_abap_2_json( usevariantmanagement ) )
                                          ( n = `useExportToExcel`  v = zjbui5_cl_util=>boolean_abap_2_json( useexporttoexcel ) )
                                          ( n = `useTablePersonalisation`  v = zjbui5_cl_util=>boolean_abap_2_json( usetablepersonalisation ) )
                                          ( n = `header`  v = header )
                                          ( n = `showRowCount`  v = zjbui5_cl_util=>boolean_abap_2_json( showrowcount ) )
                                          ( n = `enableExport`  v = zjbui5_cl_util=>boolean_abap_2_json( enableexport ) )
                                          ( n = `enableAutoBinding`  v = zjbui5_cl_util=>boolean_abap_2_json( enableautobinding ) )
                                          ) ).
  ...
  METHOD overflow_toolbar_layout_data.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ( n = `closeOverflowOnInteraction` v = zjbui5_cl_util=>boolean_abap_2_json( closeoverflowoninteraction ) )
            ( n = `group`                      v = group )
            ( n = `priority`                   v = priority ) ) ).
