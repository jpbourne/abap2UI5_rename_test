CLASS zjbui5_cl_pop_get_range DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zjbui5_cl_pop_get_range.

    TYPES:
      BEGIN OF ty_s_result,
        t_range         TYPE zjbui5_cl_util=>ty_t_range,
    ...
    DATA mt_mapping TYPE zjbui5_if_types=>ty_t_name_value.
...
CLASS zjbui5_cl_pop_get_range IMPLEMENTATION.
  METHOD factory.

    r_result = NEW #( ).

    zjbui5_cl_util=>itab_corresponding( EXPORTING val = t_range
  ...
  METHOD view_display.
    ...
    DATA(lo_popup) = zjbui5_cl_xml_view=>factory_popup( ).
  ...
  METHOD zjbui5_if_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      mt_mapping = zjbui5_cl_util=>filter_get_token_range_mapping( ).
      ...
      LOOP AT ms_result-t_range REFERENCE INTO DATA(lr_product).
        INSERT VALUE #( low    = lr_product->low
                        ...
                        key    = zjbui5_cl_util=>uuid_get_c32( )
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_ADD`.
        INSERT VALUE #( key = zjbui5_cl_util=>uuid_get_c32( ) ) INTO TABLE mt_filter.
