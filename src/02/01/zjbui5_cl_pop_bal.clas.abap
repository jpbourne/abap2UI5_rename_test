CLASS zjbui5_cl_pop_bal DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zjbui5_cl_pop_bal.
...
CLASS zjbui5_cl_pop_bal IMPLEMENTATION.
  METHOD factory.
    ...
    "read messages..
    DATA(lt_msg) = zjbui5_cl_util=>msg_get( i_messages ).
...
*      lr_row->message = `message`.
      ...
      ls_row-date = zjbui5_cl_util=>time_get_date_by_stampl( lr_row->timestampl ).
      ls_row-time = zjbui5_cl_util=>time_get_time_by_stampl( lr_row->timestampl ).
*      lr_row->group = `001`.
