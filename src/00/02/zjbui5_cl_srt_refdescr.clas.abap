...
CLASS zjbui5_cl_srt_refdescr DEFINITION
  PUBLIC
  INHERITING FROM zjbui5_cl_srt_datadescr
  CREATE PUBLIC.

  PUBLIC SECTION.

    DATA referenced_type TYPE REF TO zjbui5_cl_srt_typedescr.
...
CLASS zjbui5_cl_srt_refdescr IMPLEMENTATION.
  METHOD constructor.
    super->constructor( rtti ).
    CREATE OBJECT referenced_type TYPE zjbui5_cl_srt_typedescr
