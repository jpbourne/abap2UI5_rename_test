CLASS zjbui5_cl_util_ext DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS zjbui5_cl_util_ext IMPLEMENTATION.
...
* fallback to RTTI, KEY field does not exist in S/4 2020
    ...
    DATA(lt_comp)  =  zjbui5_cl_util=>rtti_get_t_attri_by_any( tabname ).
...
*    ENDLOOP.
  ...
  METHOD rtti_get_t_dfies_by_table_name.
    ...
    IF zjbui5_cl_util=>context_check_abap_cloud( ) IS NOT INITIAL.
...
*    set_row_id( ).
  ...
  METHOD _set_e071k.
    ...
    DATA(t_comp) = zjbui5_cl_util=>rtti_get_t_attri_by_table_name( 'E071K' ).
...
*    ENDIF.
  ...
  METHOD _set_e071.
    ...
    DATA(t_comp) = zjbui5_cl_util=>rtti_get_t_attri_by_table_name( 'E071' ).
  ...
  METHOD _read_e070.
    ...
    TRY.
        DATA(t_comp) = zjbui5_cl_util=>rtti_get_t_attri_by_table_name( table_name ).
