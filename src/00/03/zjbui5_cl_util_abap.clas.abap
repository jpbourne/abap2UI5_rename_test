CLASS zjbui5_cl_util_abap DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS zjbui5_cl_util_abap IMPLEMENTATION.

  METHOD context_get_user_tech.

    IF context_check_abap_cloud( ).
      result = zjbui5_cl_util_abap_c=>context_get_user_tech( ).
    ELSE.
      result = zjbui5_cl_util_abap_s=>context_get_user_tech( ).
    ENDIF.
