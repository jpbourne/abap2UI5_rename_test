CLASS zjbui5_cl_util_http DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_http_req,
        ...
        body     TYPE string,
        path     TYPE string,
        t_params TYPE zjbui5_cl_util=>ty_t_name_value,
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_util_http.
...
CLASS zjbui5_cl_util_http IMPLEMENTATION.
...
*      ASSERT 1 = 'NO_STATEFUL_FEATURE_IN_CLOUD_ERROR'.
  ...
  METHOD get_req_info.
    ...
    IF mo_request_cloud IS BOUND.
      ...
      result-t_params = zjbui5_cl_util=>url_param_get_tab( get_header_field( `~request_uri` ) ).
    ELSE.
