CLASS zjbui5_cl_util_abap_c DEFINITION
  PUBLIC
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS bal_save
      IMPORTING
        ...
        subobject TYPE clike
        id        TYPE clike
        t_log     TYPE zjbui5_cl_util=>ty_t_msg.

    CLASS-METHODS context_get_callstack
      RETURNING
        VALUE(result) TYPE zjbui5_cl_util=>ty_t_stack.
    ...
    CLASS-METHODS rtti_get_data_element_texts
      IMPORTING
        val           TYPE clike
      RETURNING
        VALUE(result) TYPE zjbui5_cl_util=>ty_s_data_element_text.
    ...
    CLASS-METHODS rtti_get_classes_impl_intf
      IMPORTING
        val           TYPE clike
      RETURNING
        VALUE(result) TYPE zjbui5_cl_util=>ty_t_classes.
    ...
    CLASS-METHODS rtti_get_t_fixvalues
      IMPORTING
        ...
        langu         TYPE clike
      RETURNING
        VALUE(result) TYPE zjbui5_cl_util=>ty_t_fix_val.
...
CLASS zjbui5_cl_util_abap_c IMPLEMENTATION.
  ...
  METHOD rtti_get_t_fixvalues.
    ...
    DATA temp2     TYPE zjbui5_cl_util_abap=>ty_s_fix_val.
  ...
  METHOD rtti_get_classes_impl_intf.
    ...
    DATA xco_cp_abap         TYPE c LENGTH 11.
    DATA temp3               TYPE zjbui5_cl_util_abap=>ty_t_classes.
    ...
    DATA temp6 TYPE zjbui5_cl_util_abap=>ty_s_class_descr.
  ...
  METHOD context_get_callstack.
    ...
    LOOP AT <lt_lines> INTO DATA(text).
      DATA(ls_stack) = VALUE zjbui5_cl_util_abap=>ty_S_stack( ).
