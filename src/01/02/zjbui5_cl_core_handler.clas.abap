...
CLASS zjbui5_cl_core_handler IMPLEMENTATION.
  ...
  METHOD main_end.
    ...
    IF CAST zjbui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW zjbui5_cl_core_client( mo_action ).
        DATA(li_app)    = CAST zjbui5_if_app( mo_action->mo_app->mo_app ).
