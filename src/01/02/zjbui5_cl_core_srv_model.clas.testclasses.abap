...
CLASS zjbui5_cl_core_srv_model DEFINITION LOCAL FRIENDS ltcl_test_dissolve.
...
*    ENDIF.
  ...
  METHOD test_init.
    ...
    DATA lt_attri TYPE zjbui5_if_core_types=>ty_t_attri.
    DATA(lo_model) = NEW zjbui5_cl_core_srv_model( attri = REF #( lt_attri )
                                                 app    = lo_app ).
...
CLASS zjbui5_cl_core_srv_model DEFINITION LOCAL FRIENDS ltcl_test_search_attri.
...
CLASS zjbui5_cl_core_srv_model DEFINITION LOCAL FRIENDS ltcl_test_get_attri.
...
CLASS ltcl_test_get_attri IMPLEMENTATION.
  ...
  METHOD first_test.
    ...
    DATA(lt_attri) = VALUE zjbui5_if_core_types=>ty_t_attri( ).
...
CLASS ltcl_test_app_root4 IMPLEMENTATION.
  ...
  METHOD test_tab_ref_gen.
    ...
    lo_model = NEW zjbui5_cl_core_srv_model( attri = REF #( lt_attri )
                                            app   = lo_app ).
