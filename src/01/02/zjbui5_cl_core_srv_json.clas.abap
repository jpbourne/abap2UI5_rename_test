CLASS zjbui5_cl_core_srv_json DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE zjbui5_if_core_types=>ty_s_request.

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE zjbui5_if_core_types=>ty_s_response
      RETURNING
...
CLASS zjbui5_cl_core_srv_json IMPLEMENTATION.
    ...
    TRY.
        ...
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.
          ...
          IF lr_attri->custom_mapper IS BOUND.
            DATA(ajson) = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>create_empty(
                                                   ii_custom_mapping = lr_attri->custom_mapper ) ).
          ELSE.
            ajson = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>create_empty(
...
*              ASSERT sy-subrc = 0.
  ...
  METHOD request_json_to_abap.
    ...
    "                                                                       url = result-s_front-search ) ).
            ...
            result-s_control-app_start_draft = zjbui5_cl_util=>c_trim_upper(
                                           zjbui5_cl_util=>url_param_get( val = `z2ui5-xapp-state`
                                                                         url = lv_hash ) ).
          catch cx_root.
        endtry.
        ...
        result-s_control-app_start = zjbui5_cl_util=>c_trim_upper(
                                         zjbui5_cl_util=>url_param_get( val = `app_start`
                                                                       url = result-s_front-search ) ).
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result->set( iv_path = `/`
                           iv_val  = val-s_front ).
        ajson_result = ajson_result->filter( NEW zjbui5_cl_core_srv_json( ) ).
