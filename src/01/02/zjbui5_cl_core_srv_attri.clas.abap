CLASS zjbui5_cl_core_srv_attri DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS zjbui5_cl_core_srv_attri IMPLEMENTATION.
  ...
  METHOD attri_before_save.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri).
      ...
      IF lr_attri->bind_type = zjbui5_if_core_types=>cs_bind_type-one_time.
        DELETE mt_attri->*.
        CONTINUE.
      ENDIF.

       "extra case - conversion exit alpha numeric
      IF lr_attri->bind_type = zjbui5_if_core_types=>cs_bind_type-two_way AND (
      ...
      IF <val_ref> IS NOT INITIAL.
        ...
        lr_attri->srtti_data = zjbui5_cl_util=>xml_srtti_stringify( <val> ).
        CLEAR <val>.
      ENDIF.
  ...
  METHOD attri_search_a_dissolve.
    ...
    DATA(lo_dissolve) = NEW zjbui5_cl_core_srv_diss( attri = mt_attri
                                                    app   = mo_app ).
