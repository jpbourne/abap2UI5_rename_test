CLASS zjbui5_cl_core_json_srv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE zjbui5_if_core_types=>ty_s_http_request_post .

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE zjbui5_if_core_types=>ty_s_http_response_post
      RETURNING
    ...
    METHODS model_front_to_back
      IMPORTING
        view    TYPE string
        t_attri TYPE REF TO zjbui5_if_core_types=>ty_t_attri
        model   TYPE REF TO zjbui5_if_ajson .
...
CLASS zjbui5_cl_core_json_srv IMPLEMENTATION.
  ...
  METHOD model_front_to_back.
    ...
    IF line_exists( t_attri->*[ view = view ] ).
      DATA(lv_view) = view.
    ELSE.
      lv_view = zjbui5_if_client=>cs_view-main.
    ENDIF.

    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
      WHERE bind_type = zjbui5_if_core_types=>cs_bind_type-two_way
      AND view  = lv_view.
      TRY.
        ...
        CATCH cx_root INTO DATA(x).
          zjbui5_cl_util=>x_raise( |JSON_PARSING_ERROR: { x->get_text( ) } | ).
      ENDTRY.
    ENDLOOP.
  ...
  METHOD model_back_to_front.
    TRY.
        ...
        DATA(ajson_result) = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>create_empty( ) ).
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.

          IF lr_attri->custom_mapper IS BOUND.
            DATA(ajson) = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>create_empty( ii_custom_mapping = lr_attri->custom_mapper ) ).
          ELSE.
            ajson = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>create_empty( ii_custom_mapping = zjbui5_cl_ajson_mapping=>create_upper_case( ) ) ).
          ENDIF.

          CASE lr_attri->bind_type.
            WHEN zjbui5_if_core_types=>cs_bind_type-one_way
            OR zjbui5_if_core_types=>cs_bind_type-two_way.
...
*              ASSERT sy-subrc = 0.
            ...
            WHEN zjbui5_if_core_types=>cs_bind_type-one_time.
  ...
  METHOD request_json_to_abap.
    TRY.
        ...
        DATA(lo_ajson) = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>parse( val ) ).

        DATA(lv_model_edit_name) = `/` && zjbui5_if_core_types=>cs_ui5-two_way_model.

        result-o_model = zjbui5_cl_ajson=>create_empty( ).
        ...
        TRY.
            ...
            result-s_control-app_start = zjbui5_cl_util=>c_trim_upper( result-s_control-app_start ).
          CATCH cx_root.
        ENDTRY.
        ...
        result-s_control-app_start = zjbui5_cl_util=>c_trim_upper(
        zjbui5_cl_util=>url_param_get( val = `app_start` url = result-s_front-search ) ).
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        DATA(ajson_result) = CAST zjbui5_if_ajson( zjbui5_cl_ajson=>create_empty(
          ii_custom_mapping = zjbui5_cl_ajson_mapping=>create_upper_case( ) ) ).

        ajson_result->set( iv_path = `/` iv_val = val-s_front ).
        ajson_result = ajson_result->filter( NEW zjbui5_cl_core_json_srv( ) ).
  ...
  METHOD zjbui5_if_ajson_filter~keep_node.
    ...
    CASE iv_visit.
      ...
      WHEN zjbui5_if_ajson_filter=>visit_type-value.
      ...
      WHEN zjbui5_if_ajson_filter=>visit_type-close.
