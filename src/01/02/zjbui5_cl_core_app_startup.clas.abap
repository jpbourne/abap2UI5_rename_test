CLASS zjbui5_cl_core_app_startup DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO zjbui5_cl_core_app_startup.
...
CLASS zjbui5_cl_core_app_startup IMPLEMENTATION.
  ...
  METHOD on_event_check.
    ...
    TRY.
        ...
        ms_home-url = zjbui5_cl_core_util_srv=>app_get_url(
                   client    = client
  ...
  METHOD view_display_start.
    ...
    DATA(page2) = zjbui5_cl_xml_view=>factory( )->shell( )->page(
    ...
    DATA(lv_url_samples2) = zjbui5_cl_core_util_srv=>app_get_url(
                  client    = client
  ...
  METHOD zjbui5_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      TRY.
          DATA(lo_f4) = CAST zjbui5_cl_pop_to_select( client->get_app( client->get( )-s_draft-id_prev_app ) ).
  ...
  METHOD view_display_popup.
    ...
    simple_form2->checkbox( enabled = abap_false selected = zjbui5_cl_util=>context_check_abap_cloud( ) ).

    DATA(lv_count) = CONV string( NEW zjbui5_cl_core_draft_srv( )->count_entries( ) ).
...
*        client->nav_app_call( z2ui5_cl_core_app_info=>factory( ) ).
  ...
  METHOD z2ui5_on_init.
    ...
    ms_home-class_editable = abap_true.
    ms_home-btn_icon       = `sap-icon://validate`.
    ms_home-classname      = zjbui5_cl_util=>rtti_get_classname_by_ref( NEW zjbui5_cl_hello_world( ) ).
