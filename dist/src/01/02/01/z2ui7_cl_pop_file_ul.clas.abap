CLASS z2ui7_cl_pop_file_ul DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z2ui7_cl_pop_file_ul.
...
CLASS z2ui7_cl_pop_file_ul IMPLEMENTATION.
  METHOD factory.
  ...
  METHOD z2ui7_if_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = z2ui7_cl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = z2ui7_cl_util=>conv_get_string_by_xstring( lv_data2 ).
