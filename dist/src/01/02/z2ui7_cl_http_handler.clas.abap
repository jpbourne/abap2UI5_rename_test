CLASS z2ui7_cl_http_handler DEFINITION
  PUBLIC
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    CLASS-METHODS run
      IMPORTING
        ...
        config TYPE z2ui7_if_types=>ty_s_http_config OPTIONAL
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui7_cl_http_handler.
    ...
    CLASS-METHODS _http_post
      IMPORTING
        is_req        TYPE z2ui7_if_core_types=>ty_s_http_req
      RETURNING
        VALUE(result) TYPE z2ui7_if_core_types=>ty_s_http_res.

    CLASS-METHODS _http_get
      IMPORTING
        VALUE(is_config) TYPE  z2ui7_if_types=>ty_s_http_config
      RETURNING
        VALUE(result)    TYPE string.

    METHODS main
      IMPORTING
        s_config TYPE z2ui7_if_types=>ty_s_http_config OPTIONAL.

    CLASS-METHODS _main
      IMPORTING
        is_config     TYPE  z2ui7_if_types=>ty_s_http_config
        is_req        TYPE z2ui7_if_core_types=>ty_s_http_req
      RETURNING
        VALUE(result) TYPE z2ui7_if_core_types=>ty_s_http_res.
    ...
    CLASS-METHODS get_request
      IMPORTING
        ...
        res           TYPE REF TO object OPTIONAL
          PREFERRED PARAMETER server
      RETURNING
        VALUE(result) TYPE z2ui7_if_core_types=>ty_s_http_req.
    ...
    CLASS-METHODS get_response
      IMPORTING
        ...
        req    TYPE REF TO object OPTIONAL
        res    TYPE REF TO object OPTIONAL
        is_res TYPE z2ui7_if_core_types=>ty_s_http_res.

  PROTECTED SECTION.
    CLASS-DATA so_sticky_handler TYPE REF TO z2ui7_cl_core_handler.

    DATA mo_server TYPE REF TO z2ui7_cl_util_abap_http.

    DATA ms_req    TYPE z2ui7_if_core_types=>ty_s_http_req.
    DATA ms_res    TYPE z2ui7_if_core_types=>ty_s_http_res.
    DATA ms_config TYPE z2ui7_if_types=>ty_s_http_config.
...
CLASS z2ui7_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = z2ui7_cl_util_abap_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = z2ui7_cl_util_abap_http=>factory_cloud( req = req
                                                               res  = res ).
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
    ...
    IF is_config-styles_css IS INITIAL.
      DATA(lv_style_css) = z2ui7_cl_app_style_css=>get( ).
    ELSE.
    ...
    result = |<!DOCTYPE html>| && |\n| &&
             ...
             |      "z2ui5/manifest.json": '{ z2ui7_cl_app_manifest_json=>get( ) }',| && |\n| &&
             |      "z2ui5/Component.js": function()\{{ z2ui7_cl_app_component_js=>get( ) }{ is_config-custom_js }\},| && |\n| &&
             |      "z2ui5/model/models.js": function()\{{ z2ui7_cl_app_models_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/view/App.view.xml": '{ z2ui7_cl_app_app_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/controller/App.controller.js": function()\{{ z2ui7_cl_app_app_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/view/View1.view.xml": '{ z2ui7_cl_app_view1_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/controller/View1.controller.js": function()\{{ z2ui7_cl_app_view1_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/Server.js": function()\{{ z2ui7_cl_app_server_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/DebugTool.fragment.xml": '{ z2ui7_cl_app_debugtool_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/cc/DebugTool.js": function()\{{ z2ui7_cl_app_debugtool_js=>get( ) }\},| && |\n| &&
             |    \});| && |\n| &&
  ...
  METHOD _http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW z2ui7_cl_core_handler( is_req-body ).
    ELSE.
    ...
    TRY.
        IF lo_post IS BOUND.
          DATA(li_app) = CAST z2ui7_if_app( lo_post->mo_action->mo_app->mo_app ).
