CLASS z2ui7_cl_core_srv_attri DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS attri_search_a_dissolve
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui7_if_core_types=>ty_s_attri.
...
CLASS z2ui7_cl_core_srv_attri IMPLEMENTATION.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri).
      TRY.
          ...
          IF lr_attri->srtti_data IS NOT INITIAL.
            ...
            <val> = z2ui7_cl_util=>xml_srtti_parse( lr_attri->srtti_data ).
  ...
  METHOD attri_before_save.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri).
      ...
      IF lr_attri->bind_type = z2ui7_if_core_types=>cs_bind_type-one_time.
        DELETE mt_attri->*.
        CONTINUE.
      ENDIF.
      ...
      IF <val_ref> IS NOT INITIAL.
        ...
        lr_attri->srtti_data = z2ui7_cl_util=>xml_srtti_stringify( <val> ).
        CLEAR <val>.
      ENDIF.
  ...
  METHOD attri_search_a_dissolve.
    ...
    DATA(lo_dissolve) = NEW z2ui7_cl_core_srv_diss( attri = mt_attri
                                                    app   = mo_app ).
