...
CLASS zzzz2ui5_cl_core_srv_bind DEFINITION LOCAL FRIENDS ltcl_test_bind.
...
CLASS ltcl_test_bind IMPLEMENTATION.
  METHOD test_one_way_w_x_error.
    ...
    DATA(lo_app) = NEW zzzz2ui5_cl_core_app( ).
    lo_app->mo_app = lo_app_client.

    DATA(lo_bind)  = NEW zzzz2ui5_cl_core_srv_bind( lo_app ).
