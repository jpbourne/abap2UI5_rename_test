CLASS zzzz2ui5_cl_core_srv_util DEFINITION
  PUBLIC
  INHERITING FROM zzzz2ui5_cl_util
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS app_get_url_source_code
      IMPORTING
        !client       TYPE REF TO zzzz2ui5_if_client
      RETURNING
...
CLASS zzzz2ui5_cl_core_srv_util IMPLEMENTATION.
  METHOD app_get_url.
