CLASS zzzz2ui5_cl_core_srv_json DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE zzzz2ui5_if_core_types=>ty_s_request.

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE zzzz2ui5_if_core_types=>ty_s_response
      RETURNING
    ...
    METHODS model_front_to_back
      IMPORTING
        view    TYPE string
        t_attri TYPE REF TO zzzz2ui5_if_core_types=>ty_t_attri
        model   TYPE REF TO zzzz2ui5_if_ajson.
...
CLASS zzzz2ui5_cl_core_srv_json IMPLEMENTATION.
  ...
  METHOD model_front_to_back.
    ...
    IF line_exists( t_attri->*[ view = view ] ).
      DATA(lv_view) = view.
    ELSE.
      lv_view = zzzz2ui5_if_client=>cs_view-main.
    ENDIF.

    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
         WHERE bind_type = zzzz2ui5_if_core_types=>cs_bind_type-two_way
               AND view      = lv_view.
      TRY.
  ...
  METHOD model_back_to_front.
    TRY.
        ...
        DATA(ajson_result) = CAST zzzz2ui5_if_ajson( zzzz2ui5_cl_ajson=>create_empty( ) ).
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.

          IF lr_attri->custom_mapper IS BOUND.
            DATA(ajson) = CAST zzzz2ui5_if_ajson( zzzz2ui5_cl_ajson=>create_empty(
                                                   ii_custom_mapping = lr_attri->custom_mapper ) ).
          ELSE.
            ajson = CAST zzzz2ui5_if_ajson( zzzz2ui5_cl_ajson=>create_empty(
                                             ii_custom_mapping = zzzz2ui5_cl_ajson_mapping=>create_upper_case( ) ) ).
          ENDIF.

          CASE lr_attri->bind_type.
            WHEN zzzz2ui5_if_core_types=>cs_bind_type-one_way
                OR zzzz2ui5_if_core_types=>cs_bind_type-two_way.
            ...
            WHEN zzzz2ui5_if_core_types=>cs_bind_type-one_time.
              ajson->set( iv_ignore_empty = abap_false
                          iv_path         = `/`
  ...
  METHOD request_json_to_abap.
    TRY.
        ...
        DATA(lo_ajson) = CAST zzzz2ui5_if_ajson( zzzz2ui5_cl_ajson=>parse( val ) ).

        DATA(lv_model_edit_name) = |/{ zzzz2ui5_if_core_types=>cs_ui5-two_way_model }|.

        result-o_model = zzzz2ui5_cl_ajson=>create_empty( ).
        ...
        TRY.
            IF result-s_front-o_comp_data IS BOUND.
              ...
              result-s_control-app_start = zzzz2ui5_cl_util=>c_trim_upper( result-s_control-app_start ).
            ENDIF.
          CATCH cx_root.
        ENDTRY.
        ...
        TRY.
            ...
            ENDIF.
            result-s_control-app_start_draft = zzzz2ui5_cl_util=>c_trim_upper(
                                           zzzz2ui5_cl_util=>url_param_get( val = `z2ui5-xapp-state`
                                                                         url = lv_hash ) ).
          CATCH cx_root.
        ENDTRY.
        ...
        result-s_control-app_start = zzzz2ui5_cl_util=>c_trim_upper(
                                         zzzz2ui5_cl_util=>url_param_get( val = `app_start`
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result->set( iv_path = `/`
                           iv_val  = val-s_front ).
        ajson_result = ajson_result->filter( NEW zzzz2ui5_cl_core_srv_json( ) ).
  ...
  METHOD zzzz2ui5_if_ajson_filter~keep_node.
    ...
    CASE iv_visit.
      ...
      WHEN zzzz2ui5_if_ajson_filter=>visit_type-value.
      ...
      WHEN zzzz2ui5_if_ajson_filter=>visit_type-close.
