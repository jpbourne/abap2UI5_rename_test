CLASS zzzz2ui5_cl_ajson DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.

    INTERFACES zzzz2ui5_if_ajson .

    ALIASES:
      is_empty FOR zzzz2ui5_if_ajson~is_empty,
      exists FOR zzzz2ui5_if_ajson~exists,
      members FOR zzzz2ui5_if_ajson~members,
      get FOR zzzz2ui5_if_ajson~get,
      get_boolean FOR zzzz2ui5_if_ajson~get_boolean,
      get_integer FOR zzzz2ui5_if_ajson~get_integer,
      get_number FOR zzzz2ui5_if_ajson~get_number,
      get_date FOR zzzz2ui5_if_ajson~get_date,
      get_timestamp FOR zzzz2ui5_if_ajson~get_timestamp,
      get_string FOR zzzz2ui5_if_ajson~get_string,
      slice FOR zzzz2ui5_if_ajson~slice,
      to_abap FOR zzzz2ui5_if_ajson~to_abap,
      array_to_string_table FOR zzzz2ui5_if_ajson~array_to_string_table.

    ALIASES:
      clear FOR zzzz2ui5_if_ajson~clear,
      set FOR zzzz2ui5_if_ajson~set,
      setx FOR zzzz2ui5_if_ajson~setx,
      set_boolean FOR zzzz2ui5_if_ajson~set_boolean,
      set_string FOR zzzz2ui5_if_ajson~set_string,
      set_integer FOR zzzz2ui5_if_ajson~set_integer,
      set_date FOR zzzz2ui5_if_ajson~set_date,
      set_timestamp FOR zzzz2ui5_if_ajson~set_timestamp,
      set_null FOR zzzz2ui5_if_ajson~set_null,
      delete FOR zzzz2ui5_if_ajson~delete,
      touch_array FOR zzzz2ui5_if_ajson~touch_array,
      push FOR zzzz2ui5_if_ajson~push,
      stringify FOR zzzz2ui5_if_ajson~stringify.

    ALIASES:
      clone FOR zzzz2ui5_if_ajson~clone,
      filter FOR zzzz2ui5_if_ajson~filter,
      map FOR zzzz2ui5_if_ajson~map.

    ALIASES:
      mt_json_tree FOR zzzz2ui5_if_ajson~mt_json_tree,
      keep_item_order FOR zzzz2ui5_if_ajson~keep_item_order,
      format_datetime FOR zzzz2ui5_if_ajson~format_datetime,
      to_abap_corresponding_only FOR zzzz2ui5_if_ajson~to_abap_corresponding_only,
      freeze FOR zzzz2ui5_if_ajson~freeze.

    CLASS-METHODS parse
      IMPORTING
        !iv_json            TYPE any
        !iv_freeze          TYPE abap_bool DEFAULT abap_false
        !ii_custom_mapping  TYPE REF TO zzzz2ui5_if_ajson_mapping OPTIONAL
        !iv_keep_item_order TYPE abap_bool DEFAULT abap_false
      RETURNING
        VALUE(ro_instance) TYPE REF TO zzzz2ui5_cl_ajson
      RAISING
    ...
    CLASS-METHODS create_from " TODO, rename to 'from' ?
      IMPORTING
        !ii_source_json TYPE REF TO zzzz2ui5_if_ajson
        !ii_filter TYPE REF TO zzzz2ui5_if_ajson_filter OPTIONAL " Might be deprecated, use filter() instead
        !ii_mapper TYPE REF TO zzzz2ui5_if_ajson_mapping OPTIONAL " Might be deprecated, use map() instead
      RETURNING
        VALUE(ro_instance) TYPE REF TO zzzz2ui5_cl_ajson
      RAISING
        zzzz2ui5_cx_ajson_error .
  ...
  PRIVATE SECTION.
    ...
    DATA ms_opts TYPE zzzz2ui5_if_ajson=>ty_opts.
    DATA mi_custom_mapping TYPE REF TO zzzz2ui5_if_ajson_mapping. " DEPRECATED, will be removed

    METHODS get_item
      IMPORTING
        iv_path        TYPE string
      RETURNING
        VALUE(rv_item) TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    METHODS prove_path_exists
      IMPORTING
        iv_path              TYPE string
      RETURNING
        VALUE(rr_end_node) TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node
      RAISING
        zzzz2ui5_cx_ajson_error.
    METHODS delete_subtree
      IMPORTING
        iv_path           TYPE string
        iv_name           TYPE string
        ir_parent         TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node OPTIONAL
      RETURNING
        VALUE(rs_top_node) TYPE zzzz2ui5_if_ajson_types=>ty_node.
...
CLASS zzzz2ui5_cl_ajson IMPLEMENTATION.
  ...
  METHOD create_from.
    ...
    IF ii_source_json IS NOT BOUND.
      zzzz2ui5_cx_ajson_error=>raise( 'Source not bound' ).
    ENDIF.
  ...
  METHOD get_item.
    ...
    DATA ls_path_name TYPE zzzz2ui5_if_ajson_types=>ty_path_name.
    ...
    DO.
      ...
      IF sy-subrc <> 0. " New node, assume it is always object as it has a named child, use touch_array to init array
        ...
        IF lr_node_parent IS NOT INITIAL. " if has parent
          ...
          IF lr_node_parent->type = zzzz2ui5_if_ajson_types=>node_type-array.
        ...
        ls_new_node-type = zzzz2ui5_if_ajson_types=>node_type-object.
  ...
  METHOD read_only_watchdog.
    IF ms_opts-read_only = abap_true.
      zzzz2ui5_cx_ajson_error=>raise( 'This json instance is read only' ).
    ENDIF.
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~array_to_string_table.

    DATA lv_normalized_path TYPE string.
    DATA lr_node TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    FIELD-SYMBOLS <item> LIKE LINE OF mt_json_tree.
    ...
    IF lr_node IS INITIAL.
      zzzz2ui5_cx_ajson_error=>raise( |Path not found: { iv_path }| ).
    ENDIF.
    IF lr_node->type <> zzzz2ui5_if_ajson_types=>node_type-array.
      zzzz2ui5_cx_ajson_error=>raise( |Array expected at: { iv_path }| ).
    ENDIF.

    LOOP AT mt_json_tree ASSIGNING <item> WHERE path = lv_normalized_path.
      CASE <item>-type.
        WHEN zzzz2ui5_if_ajson_types=>node_type-number OR zzzz2ui5_if_ajson_types=>node_type-string.
          APPEND <item>-value TO rt_string_table.
        WHEN zzzz2ui5_if_ajson_types=>node_type-null.
          APPEND '' TO rt_string_table.
        WHEN zzzz2ui5_if_ajson_types=>node_type-boolean.
        ...
        WHEN OTHERS.
          zzzz2ui5_cx_ajson_error=>raise( |Cannot convert [{ <item>-type
  ...
  METHOD zzzz2ui5_if_ajson~clear.
  ...
  METHOD zzzz2ui5_if_ajson~clone.
    ri_json = create_from( me ).
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~delete.

    read_only_watchdog( ).

    DATA ls_split_path TYPE zzzz2ui5_if_ajson_types=>ty_path_name.
  ...
  METHOD zzzz2ui5_if_ajson~exists.
    rv_exists = boolc( get_item( iv_path ) IS NOT INITIAL ).
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~filter.
    ri_json = create_from(
      ii_source_json = me
      ii_filter      = ii_filter ).
  ENDMETHOD.
  ...
  METHOD zzzz2ui5_if_ajson~format_datetime.
    ms_opts-format_datetime = iv_use_iso.
    ri_json = me.
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~freeze.
    ms_opts-read_only = abap_true.
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~get.

    DATA lr_item TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
  ...
  METHOD zzzz2ui5_if_ajson~get_boolean.

    DATA lr_item TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS INITIAL OR lr_item->type = zzzz2ui5_if_ajson_types=>node_type-null.
      RETURN.
    ELSEIF lr_item->type = zzzz2ui5_if_ajson_types=>node_type-boolean.
  ...
  METHOD zzzz2ui5_if_ajson~get_date.
    ...
    IF lr_item IS NOT INITIAL AND lr_item->type = zzzz2ui5_if_ajson_types=>node_type-string.
  ...
  METHOD zzzz2ui5_if_ajson~get_integer.

    DATA lr_item TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS NOT INITIAL AND lr_item->type = zzzz2ui5_if_ajson_types=>node_type-number.
      rv_value = lr_item->value.
    ENDIF.
  ...
  METHOD zzzz2ui5_if_ajson~get_node_type.
  ...
  METHOD zzzz2ui5_if_ajson~get_number.
  ...
  METHOD zzzz2ui5_if_ajson~get_string.

    DATA lr_item TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS NOT INITIAL AND lr_item->type <> zzzz2ui5_if_ajson_types=>node_type-null.
      rv_value = lr_item->value.
    ENDIF.
  ...
  METHOD zzzz2ui5_if_ajson~get_timestamp.
  ...
  METHOD zzzz2ui5_if_ajson~is_empty.
    rv_yes = boolc( lines( mt_json_tree ) = 0 ).
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~keep_item_order.
    ms_opts-keep_item_order = abap_true.
    ri_json = me.
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~map.
    ri_json = create_from(
      ii_source_json = me
      ii_mapper      = ii_mapper ).
  ENDMETHOD.
  ...
  METHOD zzzz2ui5_if_ajson~members.
  ...
  METHOD zzzz2ui5_if_ajson~opts.
    rs_opts = ms_opts.
  ENDMETHOD.


  METHOD zzzz2ui5_if_ajson~push.

    DATA lr_parent TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    DATA lr_new_node TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    ...
    IF lr_parent IS INITIAL.
      zzzz2ui5_cx_ajson_error=>raise( |Path [{ iv_path }] does not exist| ).
    ENDIF.

    IF lr_parent->type <> zzzz2ui5_if_ajson_types=>node_type-array.
      zzzz2ui5_cx_ajson_error=>raise( |Path [{ iv_path }] is not array| ).
    ENDIF.

    DATA lt_new_nodes TYPE zzzz2ui5_if_ajson_types=>ty_nodes_tt.
    DATA ls_new_path TYPE zzzz2ui5_if_ajson_types=>ty_path_name.
  ...
  METHOD zzzz2ui5_if_ajson~set.

    DATA ls_split_path TYPE zzzz2ui5_if_ajson_types=>ty_path_name.
    DATA lr_parent TYPE REF TO zzzz2ui5_if_ajson_types=>ty_node.
    DATA ls_deleted_node TYPE zzzz2ui5_if_ajson_types=>ty_node.
    DATA lv_item_order TYPE zzzz2ui5_if_ajson_types=>ty_node-order.
    ...
    IF iv_node_type IS NOT INITIAL
      AND iv_node_type <> zzzz2ui5_if_ajson_types=>node_type-boolean AND iv_node_type <> zzzz2ui5_if_ajson_types=>node_type-null
      AND iv_node_type <> zzzz2ui5_if_ajson_types=>node_type-number AND iv_node_type <> zzzz2ui5_if_ajson_types=>node_type-string.
      zzzz2ui5_cx_ajson_error=>raise( |Unexpected type { iv_node_type }| ).
    ENDIF.
    ...
    ELSEIF lr_parent->type = zzzz2ui5_if_ajson_types=>node_type-object
  ...
  METHOD zzzz2ui5_if_ajson~setx.
    ...
    IF lv_val = 'null'.
      zzzz2ui5_if_ajson~set_null( lv_path ).
    ELSEIF lv_val = 'true'.
      zzzz2ui5_if_ajson~set_boolean(
        iv_path = lv_path
        iv_val  = abap_true ).
    ELSEIF lv_val = 'false'.
      zzzz2ui5_if_ajson~set_boolean(
  ...
  METHOD zzzz2ui5_if_ajson~set_boolean.
  ...
  METHOD zzzz2ui5_if_ajson~set_date.
  ...
  METHOD zzzz2ui5_if_ajson~set_integer.
  ...
  METHOD zzzz2ui5_if_ajson~set_null.
  ...
  METHOD zzzz2ui5_if_ajson~set_string.
  ...
  METHOD zzzz2ui5_if_ajson~set_timestamp.
  ...
  METHOD zzzz2ui5_if_ajson~slice.

    DATA lo_section         TYPE REF TO zzzz2ui5_cl_ajson.
    DATA ls_item            LIKE LINE OF mt_json_tree.
    DATA lv_normalized_path TYPE string.
    DATA ls_path_parts      TYPE zzzz2ui5_if_ajson_types=>ty_path_name.
  ...
  METHOD zzzz2ui5_if_ajson~stringify.
  ...
  METHOD zzzz2ui5_if_ajson~touch_array.
    ...
    IF ls_split_path IS INITIAL. " Assign root, exceptional processing
      ...
      ls_new_node-type = zzzz2ui5_if_ajson_types=>node_type-array.
    ...
    ELSEIF lr_node->type <> zzzz2ui5_if_ajson_types=>node_type-array.
      zzzz2ui5_cx_ajson_error=>raise( |Path [{ iv_path }] already used and is not array| ).
    ENDIF.
  ...
  METHOD zzzz2ui5_if_ajson~to_abap.
    ...
    lo_to_abap->to_abap(
      EXPORTING
        it_nodes    = zzzz2ui5_if_ajson~mt_json_tree
      CHANGING
  ...
  METHOD zzzz2ui5_if_ajson~to_abap_corresponding_only.
