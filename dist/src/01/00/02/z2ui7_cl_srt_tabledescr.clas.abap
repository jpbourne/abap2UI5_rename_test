...
CLASS z2ui7_cl_srt_tabledescr DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    DATA line_type      TYPE REF TO z2ui7_cl_srt_datadescr.
...
CLASS z2ui7_cl_srt_tabledescr IMPLEMENTATION.
  METHOD constructor.
    ...
    line_type ?= z2ui7_cl_srt_typedescr=>create_by_rtti( rtti->get_table_line_type( ) ).
