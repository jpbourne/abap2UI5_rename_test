...
CLASS z2ui7_cl_srt_refdescr DEFINITION
  PUBLIC
  INHERITING FROM z2ui7_cl_srt_datadescr
  CREATE PUBLIC.

  PUBLIC SECTION.

    DATA referenced_type TYPE REF TO z2ui7_cl_srt_typedescr.
...
CLASS z2ui7_cl_srt_refdescr IMPLEMENTATION.
  METHOD constructor.
    super->constructor( rtti ).
    CREATE OBJECT referenced_type TYPE z2ui7_cl_srt_typedescr
