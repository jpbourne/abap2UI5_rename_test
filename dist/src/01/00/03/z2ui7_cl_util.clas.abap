CLASS z2ui7_cl_util DEFINITION
  PUBLIC
  INHERITING FROM z2ui7_cl_util_abap
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE z2ui7_cl_util_abap=>ty_t_fix_val ##NEEDED.
    ...
    CLASS-METHODS filter_get_sql_where
      IMPORTING
        val           TYPE  z2ui7_cl_util=>ty_t_filter_multi
      RETURNING
        VALUE(result) TYPE string.
...
CLASS z2ui7_cl_util IMPLEMENTATION.
  ...
  METHOD filter_update_tokens.
    ...
    DATA(lt_range) = z2ui7_cl_util=>filter_get_range_t_by_token_t( result[ name = name ]-t_token ).
  ...
  METHOD json_parse.
    TRY.
        ...
        z2ui7_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA(li_ajson) = CAST z2ui7_if_ajson( z2ui7_cl_ajson=>create_empty( ) ).
...
*                      v = c_trim_lower( lv_value ) ) INTO TABLE rt_params.
  ...
  METHOD xml_srtti_stringify.
    ...
    ELSE.
      ...
      TRY.
          CALL METHOD z2ui7_cl_srt_typedescr=>('CREATE_BY_DATA_OBJECT')
            EXPORTING
              data_object = data
            RECEIVING
              srtti       = srtti.
  ...
  METHOD filter_get_sql_where.
    ...
    LOOP AT val INTO DATA(ls_filter).
      ...
      DATA(lo_range) = NEW z2ui7_cl_util_range( iv_fieldname = ls_filter-name
  ...
  METHOD msg_get.
    ...
    result = z2ui7_cl_util_msg=>msg_get( val ).
