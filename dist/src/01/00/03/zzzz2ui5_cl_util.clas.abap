CLASS zzzz2ui5_cl_util DEFINITION
  PUBLIC
  INHERITING FROM zzzz2ui5_cl_util_abap
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE zzzz2ui5_cl_util_abap=>ty_t_fix_val ##NEEDED.
    ...
    CLASS-METHODS filter_get_sql_where
      IMPORTING
        val           TYPE  zzzz2ui5_cl_util=>ty_t_filter_multi
      RETURNING
        VALUE(result) TYPE string.
...
CLASS zzzz2ui5_cl_util IMPLEMENTATION.
  ...
  METHOD filter_update_tokens.
    ...
    DATA(lt_range) = zzzz2ui5_cl_util=>filter_get_range_t_by_token_t( result[ name = name ]-t_token ).
  ...
  METHOD json_parse.
    TRY.
        ...
        zzzz2ui5_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA(li_ajson) = CAST zzzz2ui5_if_ajson( zzzz2ui5_cl_ajson=>create_empty( ) ).
...
*                      v = c_trim_lower( lv_value ) ) INTO TABLE rt_params.
  ...
  METHOD xml_srtti_stringify.
    ...
    ELSE.
      ...
      TRY.
          CALL METHOD zzzz2ui5_cl_srt_typedescr=>('CREATE_BY_DATA_OBJECT')
            EXPORTING
              data_object = data
            RECEIVING
              srtti       = srtti.
  ...
  METHOD filter_get_sql_where.
    ...
    LOOP AT val INTO DATA(ls_filter).
      ...
      DATA(lo_range) = NEW zzzz2ui5_cl_util_range( iv_fieldname = ls_filter-name
  ...
  METHOD msg_get.
    ...
    result = zzzz2ui5_cl_util_msg=>msg_get( val ).
