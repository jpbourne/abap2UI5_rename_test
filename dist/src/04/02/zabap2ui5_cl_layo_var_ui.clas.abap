CLASS zabap2ui5_cl_layo_var_ui DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA mo_sql    TYPE REF TO zabap2ui5_cl_layo_var_sql.
    ...
    METHODS paint
      IMPORTING
        view   TYPE REF TO zabap2ui5_cl_xml_view
...
CLASS zabap2ui5_cl_layo_var_ui IMPLEMENTATION.
  ...
  METHOD on_event.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPDATE_TOKENS`.
        mo_sql->ms_sql-t_filter = zabap2ui5_cl_util=>filter_update_tokens(
      ...
      WHEN 'LIST_OPEN'.
        ...
        client->nav_app_call( zabap2ui5_cl_pop_get_range=>factory( ls_sql-t_range ) ).
        RETURN.
...
*    init_filter_tab( ).
  ...
  METHOD init_filter_tab.
    ...
    TRY.
        ...
        mo_sql->ms_sql-t_filter = zabap2ui5_cl_util=>filter_get_multi_by_data( <table> ).
  ...
  METHOD init_layout.
    ...
    DATA lr_table TYPE REF TO data.
    lr_table = zabap2ui5_cl_util=>rtti_create_tab_by_name( `T100` ).
    mo_layout = zabap2ui5_cl_layo_manager=>factory( control  = zabap2ui5_cl_layo_manager=>m_table
                                          data     = lr_table
