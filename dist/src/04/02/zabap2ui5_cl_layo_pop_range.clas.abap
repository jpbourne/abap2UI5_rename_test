CLASS zabap2ui5_cl_layo_pop_range DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zabap2ui5_cl_layo_pop_range.
...
CLASS zabap2ui5_cl_layo_pop_range IMPLEMENTATION.
  ...
  METHOD db_read.
    ...
    TRY.
        ...
        zabap2ui5_cl_util_db=>load_by_handle(
            EXPORTING
...
*        )->toolbar_spacer(
  ...
  METHOD read_default.
    TRY.
        ...
        DATA(r_result) = NEW zabap2ui5_cl_layo_pop_range( ).
*    r_result->ms_result-t_filter = val.
*    r_result->check_db_active = check_db_active.
