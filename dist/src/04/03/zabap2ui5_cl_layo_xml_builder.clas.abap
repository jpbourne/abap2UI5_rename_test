CLASS zabap2ui5_cl_layo_xml_builder DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    CLASS-METHODS xml_build_table
      IMPORTING
        ...
        i_xml          TYPE REF TO zabap2ui5_cl_xml_view
        i_client       TYPE REF TO zabap2ui5_if_client
        i_layout       TYPE REF TO zabap2ui5_cl_layo_manager
...
CLASS zabap2ui5_cl_layo_xml_builder IMPLEMENTATION.
  ...
  METHOD xml_build_table.
    ...
    zabap2ui5_cl_layo_pop=>render_layout_function( client = i_client
                                                         xml    = toolbar
                                                         layout = i_layout ).
