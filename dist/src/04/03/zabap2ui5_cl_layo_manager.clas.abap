CLASS zabap2ui5_cl_layo_manager DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES ty_s_Head TYPE zabap2ui5_t_11.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO zabap2ui5_cl_layo_manager.
    ...
    CLASS-METHODS choose_layout
      IMPORTING
        ...
        handle04      TYPE clike                    OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO zabap2ui5_cl_layo_pop_w_sel.
...
CLASS zabap2ui5_cl_layo_manager IMPLEMENTATION.
...
*      result = z2ui5_cl_stmpncfctn_api=>rtti_get_data_element_texts( CONV #( layout-rollname ) )-long.
      result = zabap2ui5_cl_util=>rtti_get_data_element_texts( CONV #( layout-rollname ) )-short.
    ELSE.
*      result = z2ui5_cl_stmpncfctn_api=>rtti_get_data_element_texts( CONV #( layout-alternative_text ) )-long.
      result = zabap2ui5_cl_util=>rtti_get_data_element_texts( CONV #( layout-alternative_text ) )-short.
    ENDIF.
  ...
  METHOD set_sub_columns.
    ...
    LOOP AT result REFERENCE INTO DATA(line) WHERE subcolumn IS NOT INITIAL.
      ...
      line->t_sub_col = VALUE #( FOR t IN tab
                                 ( key = zabap2ui5_cl_util=>uuid_get_c32( ) fname = t ) ).
  ...
  METHOD choose_layout.
    ...
    result = zabap2ui5_cl_layo_pop_w_sel=>factory( i_tab   = layouts
                                                    i_title = 'Layouts' ).
  ...
  METHOD create_layout_obj.
    ...
    DATA(t_comp) = zabap2ui5_cl_util=>rtti_get_t_attri_by_any( data ).
